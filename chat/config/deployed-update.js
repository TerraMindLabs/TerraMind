...
(async () => {
  ...
  console.purple('Removing all tags for TerraMind `deployed` images...');
  ...
  console.purple('Pulling latest TerraMind images...');
  ...
  console.green('Your TerraMind app is now up to date! Start the app with the following command:');
  console.purple(startCommand);
  console.orange(
    "Note: it's also recommended to clear your browser cookies and localStorage for TerraMind to assure a fully clean installation.",
  );
