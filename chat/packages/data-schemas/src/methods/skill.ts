...
/**
 * Slash-command names that collide with TerraMind / Claude Code CLI commands.
 ...
 * from Anthropic's Agent Skills spec plus the fields TerraMind needs to pass
...
export function createSkillMethods(
   ...
   * set), and TerraMind does not currently require that deployment shape. In
