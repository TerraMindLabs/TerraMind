...
describe('ArtifactCodeEditor', () => {
  ...
  it('moves the Monaco theme and its loading canvas together across contrast appearances', () => {
    ...
    expect(mockEditorProps.theme).toBe('TerraMind-high-contrast-light');
    ...
    expect(mockEditorProps.theme).toBe('TerraMind-high-contrast-dark');
    expect(container.firstElementChild).toHaveStyle({
