...
const PASTED_TEXT_STORAGE_KEY = 'TerraMind-pasted-text-file-ids';
...
const SUBMITTED_PASTES_STORAGE_KEY = 'TerraMind-submitted-paste-file-ids';
...
const RETAINED_DELETION_STORAGE_KEY = 'TerraMind-retained-file-deletions';
...
const PENDING_DISCARD_STORAGE_KEY = 'TerraMind-pending-file-discards';
