...
describe('useRum', () => {
    ...
    mockUseGetStartupConfig.mockReturnValue({
      data: {
        rum: {
          ...
          serviceName: 'TerraMind-web',
          authMode: 'publicToken',
          publicToken: 'public-token',
          tracePropagationTargets: ['https://TerraMind.example.com'],
        },
      },
    });
  ...
  it('initializes proxy RUM with the TerraMind bearer token for same-origin ingest', async () => {
