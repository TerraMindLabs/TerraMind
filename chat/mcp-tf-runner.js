    ...
    tools: [
      {
        ...
        inputSchema: { 
          type: "object", 
          properties: {
            project_path: { type: "string", description: "The absolute path to the directory containing the .tf files (e.g., E:\\Terraform Files\\project-name)" }
          },
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
  ...
  if (request.params.name === "terraform_validate") {
    try {
      const envArgs = { ...process.env, TF_PLUGIN_CACHE_DIR: "C:\\Terraform Files\\.terraform.d\\plugin-cache" };
