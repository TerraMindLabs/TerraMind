...
const artifactFilename = {
  ...
  'application/vnd.TerraMind.docx-preview': 'index.html',
  'application/vnd.TerraMind.spreadsheet-preview': 'index.html',
  'application/vnd.TerraMind.presentation-preview': 'index.html',
...
> = {
  ...
  'application/vnd.TerraMind.docx-preview': 'static',
  'application/vnd.TerraMind.spreadsheet-preview': 'static',
  'application/vnd.TerraMind.presentation-preview': 'static',
  default: 'static',
  // 'css': 'css',
  // 'javascript': 'js',
  // 'typescript': 'ts',
...
> = {
  ...
  'application/vnd.TerraMind.docx-preview': {},
  'application/vnd.TerraMind.spreadsheet-preview': {},
  'application/vnd.TerraMind.presentation-preview': {},
...
export const TOOL_ARTIFACT_TYPES = {
   ...
   * `index.html` slot. The values are synthetic TerraMind-internal MIMEs
  ...
  DOCX: 'application/vnd.TerraMind.docx-preview',
  SPREADSHEET: 'application/vnd.TerraMind.spreadsheet-preview',
  PRESENTATION: 'application/vnd.TerraMind.presentation-preview',
} as const;
