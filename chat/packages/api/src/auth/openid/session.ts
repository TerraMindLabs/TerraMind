...
export function createOpenIDSessionRefreshService(
   ...
   * @property {string} [appUserId]              — TerraMind user id bound to these session tokens.
   ...
   *
   * Use 'id_token' for flows whose downstream is the TerraMind backend itself
