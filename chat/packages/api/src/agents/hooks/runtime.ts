...
export function createPluginHookPayload(
  ...
  switch (input.hook_event_name) {
    ...
    /** TerraMind steering seal; no Claude counterpart, so it is never mapped to a declaration. */
