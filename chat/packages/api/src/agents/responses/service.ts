...
export function convertInputToMessages(input: string | InputItem[]): InternalMessage[] {
  ...
  for (const item of input) {
    ...
    if (item.type === 'message') {
      ...
      // Map developer role to system (TerraMind convention)
