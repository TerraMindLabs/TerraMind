...
describe('Footer', () => {
  test('opens the default TerraMind site link in a new tab', () => {
    render(<Footer startupConfig={null} />);
    const link = screen.getByRole('link', { name: /TerraMind/ });
    expect(link).toHaveAttribute('href', 'https://TerraMind.ai');
