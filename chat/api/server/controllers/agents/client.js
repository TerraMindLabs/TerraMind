...
const {
  ...
  TerraMind_CHECKPOINT_NAMESPACE_KEY,
  TerraMind_EVENT_ACTOR_INVOCATION_KEY,
  TerraMind_CHECKPOINT_OWNER_KEY,
  TerraMind_CHECKPOINT_STORAGE_OWNER_KEY,
  TerraMind_LEGACY_CHECKPOINT_KEY,
 ...
 * initialized agent's `model_parameters` drop it (`extractTerraMindParams`),
    ...
    try {
      ...
      config = {
        ...
        configurable: {
          ...
          checkpoint_ns: '',
          [TerraMind_CHECKPOINT_NAMESPACE_KEY]: this.checkpointNamespace,
          [TerraMind_CHECKPOINT_STORAGE_OWNER_KEY]:
          ...
          ...(this.eventActorInvocationId == null
            ? {}
            : {
                [TerraMind_EVENT_ACTOR_INVOCATION_KEY]: this.eventActorInvocationId,
                [TerraMind_CHECKPOINT_OWNER_KEY]: checkpointOwnerNamespacePrefix(
                  this.options.req.user.id,
                  this.options.req._agentEventBindingTenantId,
                ),
                ...(this.eventActorCheckpointId == null
                  ? {}
                  : { [TerraMind_LEGACY_CHECKPOINT_KEY]: this.eventActorCheckpointId }),
