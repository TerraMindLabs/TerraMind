...
_ariakit_react = __toESM(_ariakit_react);
...
let _dicebear_core = require("@dicebear/core");
let _dicebear_collection = require("@dicebear/collection");
...
let rc_input_number = require("rc-input-number");
rc_input_number = __toESM(rc_input_number);
let lucide = require("lucide");
let morphicons_react = require("morphicons/react");
...
let react_textarea_autosize = require("react-textarea-autosize");
react_textarea_autosize = __toESM(react_textarea_autosize);
...
let _ariakit_react_select = require("@ariakit/react/select");
_ariakit_react_select = __toESM(_ariakit_react_select);
let _ariakit_react_combobox = require("@ariakit/react/combobox");
_ariakit_react_combobox = __toESM(_ariakit_react_combobox);
...
let _ariakit_react_components_select_select_renderer = require("@ariakit/react-components/select/select-renderer");
...
function getRefreshEndpoint(endpoint) {
	...
	const baseUrl = (0, librechat_data_provider.apiBaseUrl)();
...
const Accordion = _radix_ui_react_accordion.Root;
const AccordionItem = react.forwardRef(({ className = "", ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_accordion.Item, {
	ref,
	className: cn("border-b", className),
	...props
}));
AccordionItem.displayName = "AccordionItem";
const AccordionTrigger = react.forwardRef(({ className = "", children, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_accordion.Header, {
	className: "flex",
	children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_radix_ui_react_accordion.Trigger, {
		...
		...props,
		children: [children, /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_icons.ChevronDownIcon, { className: "h-4 w-4 shrink-0 text-text-secondary transition-transform duration-200" })]
	})
}));
AccordionTrigger.displayName = _radix_ui_react_accordion.Trigger.displayName;
const AccordionContent = react.forwardRef(({ className = "", children, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_accordion.Content, {
	ref,
...
AccordionContent.displayName = _radix_ui_react_accordion.Content.displayName;
//#endregion
...
const Tab = (0, react.forwardRef)(function Tab(props, ref) {
...
const TabPanel = (0, react.forwardRef)(function TabPanel(props, ref) {
	const tab = _ariakit_react.useTabContext();
	const previousTabId = usePrevious(_ariakit_react.useStoreState(tab, "selectedId"));
...
function AnimatedTabs({ tabs, className = "", tabListClassName = "", tabClassName = "", tabPanelClassName = "", containerClassName = "", tabListProps = {}, defaultSelectedId }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_ariakit_react.TabProvider, {
			defaultSelectedId: firstTabId,
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react.TabList, {
				ref: tabListRef,
				"aria-label": "Tabs",
				className: `animated-tab-list flex py-1 ${tabListClassName}`,
				...tabListProps,
				children: tabs.map((tab, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Tab, {
					id: tabIds[index],
				...
				children: tabs.map((tab, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TabPanel, {
...
const alertVariants = (0, class_variance_authority.cva)("relative flex gap-3 rounded-xl border px-4 py-3 text-sm", {
	variants: { variant: {
...
const Alert = react.forwardRef(({ className, variant = "info", icon, role = "alert", children, ...props }, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		...props,
		children: [icon !== false && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
			className: "mt-0.5 shrink-0",
			"aria-hidden": "true",
			children: icon ?? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DefaultIcon, { className: "size-4" })
		}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
...
const AlertDialogPortal = ({ className = "", children, ...props }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_alert_dialog.Portal, {
...
AlertDialogPortal.displayName = _radix_ui_react_alert_dialog.Portal.displayName;
const AlertDialogOverlay = react.forwardRef(({ className = "", ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_alert_dialog.Overlay, {
...
const AlertDialogContent = react.forwardRef(({ className = "", ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(AlertDialogPortal, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(AlertDialogOverlay, {}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_alert_dialog.Content, {
	ref,
	className: cn(
...
const AlertDialogTitle = react.forwardRef(({ className = "", ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_alert_dialog.Title, {
	ref,
	className: cn("text-lg font-semibold text-text-primary", className),
	...props
}));
AlertDialogTitle.displayName = _radix_ui_react_alert_dialog.Title.displayName;
const AlertDialogDescription = react.forwardRef(({ className = "", ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_alert_dialog.Description, {
	ref,
	className: cn("text-sm text-text-secondary", className),
	...props
}));
AlertDialogDescription.displayName = _radix_ui_react_alert_dialog.Description.displayName;
const AlertDialogAction = react.forwardRef(({ className = "", ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_alert_dialog.Action, {
	ref,
...
const AlertDialogCancel = react.forwardRef(({ className = "", ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_alert_dialog.Cancel, {
	ref,
...
const Breadcrumb = react.forwardRef(({ ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("nav", {
	ref,
	"aria-label": "breadcrumb",
	...props
}));
Breadcrumb.displayName = "Breadcrumb";
const BreadcrumbList = react.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("ol", {
	ref,
	className: cn("flex flex-wrap items-center gap-1.5 break-words text-sm text-text-secondary sm:gap-2.5", className),
	...props
}));
BreadcrumbList.displayName = "BreadcrumbList";
const BreadcrumbItem = react.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", {
	ref,
...
const BreadcrumbPage = react.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
	ref,
	role: "link",
	"aria-disabled": "true",
	"aria-current": "page",
...
const BreadcrumbSeparator = ({ children, className, ...props }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", {
	role: "presentation",
	"aria-hidden": "true",
...
const buttonVariantRecipe = (0, class_variance_authority.cva)("inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-surface-primary transition-colors duration-theme-fast focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-text-primary focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50", {
	variants: {
		variant: {
...
const Button = react.forwardRef(({ className, variant, size, shape, asChild = false, type = "button", ...props }, ref) => {
...
const iconButtonVariants = (0, class_variance_authority.cva)("inline-flex shrink-0 items-center justify-center text-text-primary transition-colors duration-theme-fast focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-text-primary focus-visible:ring-offset-2 focus-visible:ring-offset-surface-primary disabled:pointer-events-none disabled:opacity-50", {
	variants: {
		variant: {
...
const IconButton = react.forwardRef(({ className, label, type = "button", variant, size, shape, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
	ref,
	type,
	"aria-label": label,
...
const chipVariants = (0, class_variance_authority.cva)("inline-flex max-w-full items-center gap-1 border text-xs font-medium transition-colors duration-theme-fast", {
	variants: {
		tone: {
			neutral: "border-status-neutral-border bg-status-neutral-subtle text-status-neutral",
			info: "border-status-info-border bg-status-info-subtle text-status-info",
...
const Chip = react.forwardRef(({ children, className, leading, onRemove, removeLabel = "Remove", shape, size, tone, trailing, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
	ref,
	...
	children: [
		...
		trailing,
		onRemove && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconButton, {
			label: removeLabel,
			size: "xs",
...
const Checkbox = react.forwardRef(({ className = "", ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_checkbox.Root, {
	ref,
...
*/
const disclosureChevronVariants = (0, class_variance_authority.cva)("shrink-0 text-text-secondary opacity-0 transition-transform duration-200 ease-out group-focus-within/disclosure:opacity-100 group-hover/disclosure:opacity-100 motion-reduce:transition-none", {
	variants: { expanded: {
		true: "rotate-180",
		false: ""
	} },
...
//#endregion
//#region src/store.ts
const chatDirectionAtom = (0, jotai.atom)("ltr");
const fontSizeAtom = (0, jotai.atom)("text-base");
const toastState = (0, jotai.atom)({
	open: false,
	message: "",
	severity: "success",
	showIcon: true,
...
function useToast(showDelay = 100) {
	const [toast, setToast] = (0, jotai.useAtom)(toastState);
...
const useAvatar = (user) => {
	return (0, react.useMemo)(() => {
		...
		const avatar = (0, _dicebear_core.createAvatar)(_dicebear_collection.initials, {
			seed,
			fontFamily: ["Verdana"],
			fontSize: 36,
...
function useCombobox({ value, options }) {
	...
	return {
		...
		searchValue,
		setSearchValue,
		matches: (0, react.useMemo)(() => {
			if (!searchValue) return options;
			const matches = (0, match_sorter.matchSorter)(options, searchValue, { keys: ["label", "value"] });
...
function useLocalize() {
	...
	return (0, react.useCallback)((phraseKey, options) => t(phraseKey, options), [t]);
}
//#endregion
...
function useMediaQuery(query) {
	const [matches, setMatches] = (0, react.useState)(() => readMatches(query));
	(0, react.useEffect)(() => {
...
const useDelayedRender = (delay) => {
	const [delayed, setDelayed] = (0, react.useState)(true);
	const timerPromiseRef = (0, react.useRef)(null);
	(0, react.useEffect)(() => {
...
const DialogPortal$1 = ({ className = "", children, ...props }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_dialog.Portal, {
	className: cn(className),
	...props,
	children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
...
DialogPortal$1.displayName = _radix_ui_react_dialog.Portal.displayName;
const DialogOverlay$1 = react.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_dialog.Overlay, {
...
DialogOverlay$1.displayName = _radix_ui_react_dialog.Overlay.displayName;
const DialogContent = react.forwardRef(({ className, children = true, showCloseButton = true, disableScroll = false, ...props }, ref) => {
	const isSmallScreen = useMediaQuery("(max-width: 768px)");
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(DialogPortal$1, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(DialogOverlay$1, {}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_radix_ui_react_dialog.Content, {
		ref,
		className: cn(
...
const DialogTitle = react.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_dialog.Title, {
	ref,
	className: cn("text-lg font-semibold text-text-primary", className ?? ""),
	...props
}));
DialogTitle.displayName = _radix_ui_react_dialog.Title.displayName;
const DialogDescription = react.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_dialog.Description, {
	ref,
	className: cn("text-sm text-text-secondary", className ?? ""),
	...props
}));
DialogDescription.displayName = _radix_ui_react_dialog.Description.displayName;
const DialogClose = react.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_dialog.Close, {
	ref,
...
DialogClose.displayName = _radix_ui_react_dialog.Title.displayName;
const DialogButton = react.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Button, {
	ref,
	variant: "outline",
...
DialogButton.displayName = _radix_ui_react_dialog.Title.displayName;
//#endregion
...
const useDialogDepth = () => react.useContext(DialogDepthContext);
/**
...
const Dialog$1 = react.forwardRef(({ children, triggerRef, triggerRefs, onOpenChange, ...props }, ref) => {
	const currentDepth = react.useContext(DialogDepthContext) + 1;
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DialogDepthContext.Provider, {
		value: currentDepth,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_dialog.Root, {
			...props,
...
const DialogTrigger$1 = _radix_ui_react_dialog.Trigger;
const DialogPortal = _radix_ui_react_dialog.Portal;
const DialogClose$1 = _radix_ui_react_dialog.Close;
const DialogOverlay = react.forwardRef(({ className, style, ...props }, ref) => {
	const overlayZIndex = 130 + (react.useContext(DialogDepthContext) - 1) * 60;
...
const DialogContent$1 = react.forwardRef(({ className, overlayClassName, showCloseButton = true, children, style, onEscapeKeyDown: propsOnEscapeKeyDown, ...props }, ref) => {
	const contentZIndex = 140 + (react.useContext(DialogDepthContext) - 1) * 60;
	...
	* alike.
	*/
	const escapeFallbackRef = react.useRef(null);
	react.useEffect(() => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(DialogPortal, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(DialogOverlay, { className: overlayClassName }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_radix_ui_react_dialog.Content, {
		ref: composedRef,
		style: {
			...style,
		...
		children: [
			...
			showCloseButton && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_radix_ui_react_dialog.Close, {
...
DialogContent$1.displayName = _radix_ui_react_dialog.Content.displayName;
const DialogHeader$1 = ({ className, ...props }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
	className: cn("flex flex-col space-y-1.5 text-center sm:text-left", className),
	...props
});
DialogHeader$1.displayName = "DialogHeader";
const DialogFooter$1 = ({ className, ...props }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
	className: cn("flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2", className),
	...props
});
DialogFooter$1.displayName = "DialogFooter";
const DialogTitle$1 = react.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_dialog.Title, {
	ref,
	className: cn("text-lg font-semibold leading-none tracking-tight", className),
	...props
}));
DialogTitle$1.displayName = _radix_ui_react_dialog.Title.displayName;
const DialogDescription$1 = react.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_dialog.Description, {
	ref,
	className: cn("text-sm text-text-secondary", className),
	...props
}));
DialogDescription$1.displayName = _radix_ui_react_dialog.Description.displayName;
//#endregion
...
const HoverCardContent = react.forwardRef(({ className = "", align = "center", sideOffset = 6, disabled = false, style, ...props }, ref) => {
	const nestedStyle = useNestedPopoverStyle();
	if (disabled) return null;
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_hover_card.Content, {
		ref,
		align,
		sideOffset,
		style: {
...
const InputNumber = react.forwardRef(({ className, ...props }, ref) => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(rc_input_number.default, {
...
const SecretInput = react.forwardRef(({ id, label, className, showCopy = false, copyButton, labelClassName, containerClassName, controlsClassName, buttonClassName, controlsOnHover = false, onCopy, copyFeedbackDuration = 2e3, disabled, value, ...props }, ref) => {
	const [isVisible, setIsVisible] = (0, react.useState)(false);
	const [isCopied, setIsCopied] = (0, react.useState)(false);
	const toggleVisibility = (0, react.useCallback)(() => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					copyButton,
					showCopy && copyButton == null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						onClick: handleCopy,
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(morphicons_react.MorphIcon, {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(morphicons_react.MorphIcon, {
							icon: isVisible ? lucide.EyeOff : lucide.Eye,
							className: "size-4"
						})
					})
				]
...
* />
*/
const FilterInput = react.forwardRef(({ className, label, inputId, containerClassName, ...props }, ref) => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
...
*/
const labelVariants = (0, class_variance_authority.cva)("", {
	variants: { variant: {
...
const Label = react.forwardRef(({ className = "", variant, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_label.Root, {
	ref,
	...props,
...
const QuestionMark = ({ className = "" }) => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
...
const Slider = react.forwardRef(({ className, onDoubleClick, "aria-labelledby": ariaLabelledBy, "aria-label": ariaLabel, "aria-describedby": ariaDescribedBy, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_radix_ui_react_slider.Root, {
	ref,
	...props,
	...
	children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_slider.Track, {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_slider.Range, { className: "absolute h-full bg-surface-inverted" })
	}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_slider.Thumb, {
...
const InputCombobox = ({ label, labelClassName, placeholder = "Select an option", options, className, value, onChange, onBlur }) => {
	...
	const [isOpen, setIsOpen] = react.default.useState(false);
	const [inputValue, setInputValue] = react.default.useState(value);
	const [isKeyboardFocus, setIsKeyboardFocus] = react.default.useState(false);
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_ariakit_react.ComboboxProvider, {
		value: inputValue,
		setValue: handleChange,
		children: [
			label != null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react.ComboboxLabel, {
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react.Combobox, {
					placeholder,
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react.ComboboxPopover, {
				gutter: 4,
				sameWidth: true,
				open: isOpen,
				...
				children: options.map((option, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_ariakit_react.ComboboxItem, {
					...
					children: [isOptionObject(option) && option.icon != null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
...
const Switch = react.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_switch.Root, {
	...
	...props,
	ref,
	children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_switch.Thumb, { className: cn("pointer-events-none block h-5 w-5 rounded-full bg-surface-primary shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0") })
}));
Switch.displayName = _radix_ui_react_switch.Root.displayName;
//#endregion
//#region src/components/Table.tsx
const Table = react.forwardRef(({ className, unwrapped = false, ...props }, ref) => {
	const tableElement = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("table", {
		ref,
...
const TableRowHeader = react.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("th", {
	ref,
	scope: "row",
...
const TabsList = react.forwardRef(({ className = "", ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_tabs.List, {
	ref,
	className: cn("inline-flex items-center justify-center rounded-md bg-surface-primary", className),
	...props
}));
TabsList.displayName = _radix_ui_react_tabs.List.displayName;
const TabsTrigger = react.forwardRef(({ className = "", ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_tabs.Trigger, {
...
TabsTrigger.displayName = _radix_ui_react_tabs.Trigger.displayName;
const TabsContent = react.forwardRef(({ className = "", ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_tabs.Content, {
	className: cn("mt-2 rounded-md p-6", className),
	...props,
	ref
}));
TabsContent.displayName = _radix_ui_react_tabs.Content.displayName;
//#endregion
//#region src/components/Tag.tsx
const TagPrimitiveRoot = react.forwardRef(({ CancelButton, LabelNode, label, onRemove, className = "", labelClassName = "", variant = "success", ...props }, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [LabelNode ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [LabelNode, " "] }) : null, label]
		}), CancelButton ? CancelButton : onRemove && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconButton, {
			label: `Remove ${label}`,
			size: "xs",
...
const Tag = react.memo(TagPrimitiveRoot);
//#endregion
...
const TextareaAutosize = (0, react.forwardRef)((props, ref) => {
	const [, setIsRerendered] = (0, react.useState)(false);
	const chatDirection = (0, jotai.useAtomValue)(chatDirectionAtom).toLowerCase();
	(0, react.useLayoutEffect)(() => setIsRerendered(true), []);
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_textarea_autosize.default, {
		dir: chatDirection,
		...props,
		ref
	});
...
function Toast() {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_toast.Root, {
		open: toast.open,
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					toast.showIcon && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("polygon", { points: "7.86 2 16.14 2 22 7.86 22 16.14 16.14 22 7.86 22 2 16.14 2 7.86 7.86 2" }),
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_toast.Description, {
					...
					persistent && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_toast.Close, {
...
*/
const TooltipPopup = (0, react.memo)(function TooltipPopup({ store, description, enableHTML, portalElement }) {
	const mounted = _ariakit_react.useStoreState(store, (state) => state.mounted);
	const placement = _ariakit_react.useStoreState(store, (state) => state.placement);
	...
	* the stylesheet default so tooltips never outrank freshly opened dialogs. */
	...
	const sanitizer = (0, react.useMemo)(() => {
		const instance = (0, dompurify.default)();
	...
	const sanitizedHTML = (0, react.useMemo)(() => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(framer_motion.AnimatePresence, { children: mounted === true && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_ariakit_react.Tooltip, {
		gutter: 4,
		alwaysVisible: true,
		portalElement,
		className: "tooltip",
		render: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(framer_motion.motion.div, {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react.TooltipArrow, {}), enableHTML ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { dangerouslySetInnerHTML: { __html: sanitizedHTML } }) : description]
	}) });
});
const TooltipAnchor = (0, react.forwardRef)(function TooltipAnchor({ description, side = "top", className, role, enableHTML = false, portalElement, onKeyDown, tabIndex, ...props }, ref) {
	const tooltip = _ariakit_react.useTooltipStore({ placement: side });
	/**
	...
	*/
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_ariakit_react.TooltipProvider, {
		store: tooltip,
		hideTimeout: 0,
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react.TooltipAnchor, {
			...props,
			ref,
			role,
		...
		}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TooltipPopup, {
			store: tooltip,
			description,
			enableHTML,
			portalElement
...
const PaginationContent = react.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("ul", {
	ref,
	className: cn("flex flex-row items-center gap-1", className),
	...props
}));
PaginationContent.displayName = "PaginationContent";
const PaginationItem = react.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", {
	ref,
	className: cn("", className),
	...props
}));
PaginationItem.displayName = "PaginationItem";
const PaginationLink = ({ className, isActive = false, size = "icon", children, ...props }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("a", {
...
const PaginationNext = ({ className, ...props }) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(PaginationLink, {
	...
	...props,
	children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "Next" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.ChevronRight, {
		className: "h-4 w-4",
		"aria-hidden": "true"
	})]
});
...
Progress.displayName = _radix_ui_react_progress.Root.displayName;
//#endregion
...
*/
const SegmentedMeter = react.forwardRef(({ segments, max, highlightId, className, ...props }, ref) => {
...
const InputOTP = react.forwardRef(({ className, containerClassName, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(input_otp.OTPInput, {
	ref,
...
const InputOTPGroup = react.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
	ref,
...
const InputOTPSlot = react.forwardRef(({ index, className, ...props }, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [char, hasFakeCaret && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { className: "animate-caret-blink h-4 w-px bg-text-primary duration-1000" })
		})]
	});
});
InputOTPSlot.displayName = "InputOTPSlot";
const InputOTPSeparator = react.forwardRef(({ ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
	ref,
	role: "separator",
	...props,
...
function MultiSearch({ value, onChange, placeholder, className = "" }) {
	...
	const onChangeHandler = (0, react.useCallback)((e) => onChange(e.target.value), [onChange]);
	const clearSearch = () => {
		onChange("");
		setTimeout(() => {
...
function useMultiSearch({ availableOptions = [], placeholder, getTextKeyOverride, className, disabled = false }) {
	const [filterValue, setFilterValue] = (0, react.useState)(null);
	...
	const onSearchChange = (0, react.useCallback)((nextFilterValue) => setFilterValue(nextFilterValue), []);
	return [filteredOptions, shouldShowSearch ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MultiSearch, {
		value: filterValue,
		className,
...
const ResizablePanelGroup = ({ className = "", ...props }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_resizable_panels.Group, {
	className: cn("h-full w-full", className),
	...props
});
const ResizablePanel = react_resizable_panels.Panel;
const ResizableHandle = ({ withHandle, className = "", ...props }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_resizable_panels.Separator, {
	...
	children: withHandle && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.GripVertical, { className: "h-2.5 w-2.5" })
	})
});
const ResizableHandleAlt = ({ withHandle, className = "", ...props }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_resizable_panels.Separator, {
...
const SelectTrigger = react.forwardRef(({ className = "", children, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_radix_ui_react_select.Trigger, {
	ref,
	...
	children: [children, /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_select.Icon, {
		asChild: true,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_icons.CaretSortIcon, { className: "h-4 w-4 opacity-50" })
	})]
}));
SelectTrigger.displayName = _radix_ui_react_select.Trigger.displayName;
const SelectScrollUpButton = react.forwardRef(({ className = "", ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_select.ScrollUpButton, {
	ref,
	className: cn("flex cursor-default items-center justify-center py-1", className),
	...props,
	children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_icons.ChevronUpIcon, {})
}));
SelectScrollUpButton.displayName = _radix_ui_react_select.ScrollUpButton.displayName;
const SelectScrollDownButton = react.forwardRef(({ className = "", ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_select.ScrollDownButton, {
	ref,
	className: cn("flex cursor-default items-center justify-center py-1", className),
	...props,
	children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_icons.ChevronDownIcon, {})
}));
...
SelectContent.displayName = _radix_ui_react_select.Content.displayName;
const SelectLabel = react.forwardRef(({ className = "", ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_select.Label, {
	ref,
	className: cn("px-2 py-1.5 text-sm font-semibold", className),
	...props
}));
SelectLabel.displayName = _radix_ui_react_select.Label.displayName;
const SelectItem = react.forwardRef(({ className = "", children, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_radix_ui_react_select.Item, {
	ref,
	...
	children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_select.ItemIndicator, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_icons.CheckIcon, { className: "h-4 w-4" }) })
	}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_select.ItemText, { children })]
}));
SelectItem.displayName = _radix_ui_react_select.Item.displayName;
const SelectSeparator = react.forwardRef(({ className = "", ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_select.Separator, {
	ref,
	className: cn("-mx-1 my-1 h-px bg-surface-tertiary", className),
	...props
}));
SelectSeparator.displayName = _radix_ui_react_select.Separator.displayName;
//#endregion
//#region src/components/Radio.tsx
/** Matches the `inset-y-1` the single-row indicator uses. */
const INDICATOR_INSET = 4;
const Radio = (0, react.memo)(function Radio({ options, value, onChange, disabled = false, className = "", buttonClassName = "", fullWidth = false, wrap = false, "aria-labelledby": ariaLabelledBy }) {
	const localize = useLocalize();
	...
	const [backgroundStyle, setBackgroundStyle] = (0, react.useState)({});
	const handleChange = (newValue) => {
	...
	*  segment but never reach the others' selection behavior. */
	...
	const updateBackgroundStyle = (0, react.useCallback)(() => {
	...
	if (options.length === 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		role: "radiogroup",
		"aria-labelledby": ariaLabelledBy,
		children: [selectedIndex >= 0 && isMounted && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		}), options.map((option, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
			ref: (el) => {
			...
			children: [option.icon && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
...
function Badge({ icon: Icon, label, id, isActive = false, isEditing = false, isDragging = false, isAvailable = true, isInChat = false, onBadgeAction, onToggle, className, ...props }) {
	...
	const badgeContent = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
		...
		isEditing && !isDragging && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(framer_motion.motion.button, {
			type: "button",
			...
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(morphicons_react.MorphIcon, {
				icon: isAvailable ? lucide.X : lucide.Plus,
				className: "h-3 w-3"
			})
		})
	] });
	if (isEditing) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(framer_motion.motion.div, {
		...buttonProps,
...
function Blocks({ className = "" }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("rect", {
			...
			y: "3",
			rx: "1"
		}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M10 21V8a1 1 0 0 0-1-1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-5a1 1 0 0 0-1-1H3" })]
	});
}
//#endregion
...
function Plugin({ className = "", ...props }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("g", {
			fill: "currentColor",
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M13.164.98a.7.7 0 0 0-1.328 0l-.478 1.435a.7.7 0 0 1-.443.443l-1.436.478a.7.7 0 0 0 0 1.328l1.436.479a.7.7 0 0 1 .443.442l.478 1.436a.7.7 0 0 0 1.328 0l.478-1.436a.7.7 0 0 1 .443-.443l1.436-.478a.7.7 0 0 0 0-1.328l-1.436-.478a.7.7 0 0 1-.443-.443L13.164.979Z" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M13.237 10.534c-.228-.245-.513-.46-.847-.46a.823.823 0 0 0-.828.849c.04 1.04.128 2.067.263 3.08a.619.619 0 0 1-.528.695c-.872.121-1.748.208-2.626.262a.8.8 0 0 1-.845-.805c0-.325.21-.602.45-.82.235-.215.375-.488.375-.787 0-.683-.738-1.237-1.65-1.237-.911 0-1.65.554-1.65 1.237 0 .294.137.563.364.775.245.229.461.513.461.848a.823.823 0 0 1-.85.829 33.809 33.809 0 0 1-3.266-.278.619.619 0 0 1-.532-.532 34.099 34.099 0 0 1-.278-3.267.823.823 0 0 1 .83-.85c.333 0 .619.216.846.461.212.228.482.364.776.364.683 0 1.237-.738 1.237-1.65 0-.91-.554-1.65-1.237-1.65-.299 0-.572.142-.786.376-.219.24-.496.45-.821.45a.8.8 0 0 1-.805-.845c.054-.885.142-1.76.262-2.626a.619.619 0 0 1 .695-.528c1.022.136 2.05.224 3.08.263a.822.822 0 0 0 .85-.828c0-.334-.217-.62-.462-.847-.227-.212-.363-.482-.363-.776C5.352 1.554 6.09 1 7.002 1c.91 0 1.649.554 1.649 1.237 0 .173-.012.327-.029.473C8.258 3 8 3.41 8 4c0 1.5 1.667 1.833 2.5 2 .167.833.5 2.5 2 2.5.732 0 1.186-.397 1.479-.9l.034-.001c.683 0 1.237.738 1.237 1.65 0 .911-.554 1.65-1.237 1.65-.294 0-.564-.137-.776-.364Z" })]
		})
	});
}
//#endregion
...
const EditIcon = react.default.forwardRef((props, ref) => {
...
function MessagesSquared({ className }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
		...
		"aria-hidden": "true",
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M14 9a2 2 0 0 1-2 2H6l-4 4V4c0-1.1.9-2 2-2h8a2 2 0 0 1 2 2v5Z" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M18 9h2a2 2 0 0 1 2 2v11l-4-4h-6a2 2 0 0 1-2-2v-1" })]
	});
}
//#endregion
...
function ContinueIcon({ className = "" }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
		...
		xmlns: "http://www.w3.org/2000/svg",
		"aria-hidden": "true",
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("polygon", { points: "11 19 2 12 11 5 11 19" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("polygon", { points: "22 19 13 12 22 5 22 19" })]
	});
}
//#endregion
...
function SamlIcon() {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("g", {
			fill: "#000000",
			children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M7.754 2l.463.41c.343.304.687.607 1.026.915C11.44 5.32 13.3 7.565 14.7 10.149c.072.132.137.268.202.403l.098.203-.108.057-.081-.115-.21-.299-.147-.214c-1.019-1.479-2.04-2.96-3.442-4.145a6.563 6.563 0 00-1.393-.904c-1.014-.485-1.916-.291-2.69.505-.736.757-1.118 1.697-1.463 2.653-.045.123-.092.245-.139.367l-.082.215-.172-.055c.1-.348.192-.698.284-1.049.21-.795.42-1.59.712-2.356.31-.816.702-1.603 1.093-2.39.169-.341.338-.682.5-1.025h.092z" }),
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M8.448 11.822c-1.626.77-5.56 1.564-7.426 1.36C.717 11.576 3.71 4.05 5.18 2.91l-.095.218a4.638 4.638 0 01-.138.303l-.066.129c-.76 1.462-1.519 2.926-1.908 4.53a7.482 7.482 0 00-.228 1.689c-.01 1.34.824 2.252 2.217 2.309.67.027 1.347-.043 2.023-.114.294-.03.587-.061.88-.084.108-.008.214-.021.352-.039l.231-.028z" }),
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M3.825 14.781c-.445.034-.89.068-1.333.108 4.097.39 8.03-.277 11.91-1.644-1.265-2.23-2.97-3.991-4.952-5.522.026.098.084.169.141.239l.048.06c.17.226.348.448.527.67.409.509.818 1.018 1.126 1.578.778 1.42.356 2.648-1.168 3.296-1.002.427-2.097.718-3.18.892-1.03.164-2.075.243-3.119.323z" })
			]
		})
	});
}
...
function PinIcon({ unpin = false }) {
	if (unpin) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
		width: "24",
		height: "24",
		viewBox: "0 0 24 24",
		fill: "none",
...
function AzureMinimalIcon({ size = 25, className = "h-4 w-4" }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
		...
		"aria-hidden": "true",
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "m8.0458 0.81981a1.1197 1.1197 0 0 0-1.0608 0.76184l-6.7912 20.123a1.1178 1.1178 0 0 0 1.0592 1.4751h5.4647a1.1197 1.1197 0 0 0 1.0608-0.7615l1.3528-4.0084-2.3684-2.2107a0.51536 0.51536 0 0 1 0.35193-0.8923h3.0639l1.8213-5.3966-2.8111-8.3294a1.1181 1.1181 0 0 0-1.0595-0.76049h-0.0836z" }),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "m7.1147 15.307a0.51536 0.51536 0 0 0-0.35193 0.8923l7.1552 6.6782a1.1248 1.1248 0 0 0 0.76724 0.30238h0.2417a1.1181 1.1181 0 0 0 1.0534-1.4755l-2.1591-6.3974z" }),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "m17.015 1.5807a1.1178 1.1178 0 0 0-1.0593-0.76049h-7.8258a1.1181 1.1181 0 0 1 1.0593 0.76049l6.7916 20.123a1.1181 1.1181 0 0 1-1.0593 1.4757h7.8261a1.1181 1.1181 0 0 0 1.059-1.4757z" })
		]
	});
}
//#endregion
...
function OpenAIMinimalIcon({ className = "h-4 w-4" }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
		...
		xmlns: "http://www.w3.org/2000/svg",
		"aria-hidden": "true",
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M37.5324 16.8707C37.9808 15.5241 38.1363 14.0974 37.9886 12.6859C37.8409 11.2744 37.3934 9.91076 36.676 8.68622C35.6126 6.83404 33.9882 5.3676 32.0373 4.4985C30.0864 3.62941 27.9098 3.40259 25.8215 3.85078C24.8796 2.7893 23.7219 1.94125 22.4257 1.36341C21.1295 0.785575 19.7249 0.491269 18.3058 0.500197C16.1708 0.495044 14.0893 1.16803 12.3614 2.42214C10.6335 3.67624 9.34853 5.44666 8.6917 7.47815C7.30085 7.76286 5.98686 8.3414 4.8377 9.17505C3.68854 10.0087 2.73073 11.0782 2.02839 12.312C0.956464 14.1591 0.498905 16.2988 0.721698 18.4228C0.944492 20.5467 1.83612 22.5449 3.268 24.1293C2.81966 25.4759 2.66413 26.9026 2.81182 28.3141C2.95951 29.7256 3.40701 31.0892 4.12437 32.3138C5.18791 34.1659 6.8123 35.6322 8.76321 36.5013C10.7141 37.3704 12.8907 37.5973 14.9789 37.1492C15.9208 38.2107 17.0786 39.0587 18.3747 39.6366C19.6709 40.2144 21.0755 40.5087 22.4946 40.4998C24.6307 40.5054 26.7133 39.8321 28.4418 38.5772C30.1704 37.3223 31.4556 35.5506 32.1119 33.5179C33.5027 33.2332 34.8167 32.6547 35.9659 31.821C37.115 30.9874 38.0728 29.9178 38.7752 28.684C39.8458 26.8371 40.3023 24.6979 40.0789 22.5748C39.8556 20.4517 38.9639 18.4544 37.5324 16.8707ZM22.4978 37.8849C20.7443 37.8874 19.0459 37.2733 17.6994 36.1501C17.7601 36.117 17.8666 36.0586 17.936 36.0161L25.9004 31.4156C26.1003 31.3019 26.2663 31.137 26.3813 30.9378C26.4964 30.7386 26.5563 30.5124 26.5549 30.2825V19.0542L29.9213 20.998C29.9389 21.0068 29.9541 21.0198 29.9656 21.0359C29.977 21.052 29.9842 21.0707 29.9867 21.0902V30.3889C29.9842 32.375 29.1946 34.2791 27.7909 35.6841C26.3872 37.0892 24.4838 37.8806 22.4978 37.8849ZM6.39227 31.0064C5.51397 29.4888 5.19742 27.7107 5.49804 25.9832C5.55718 26.0187 5.66048 26.0818 5.73461 26.1244L13.699 30.7248C13.8975 30.8408 14.1233 30.902 14.3532 30.902C14.583 30.902 14.8088 30.8408 15.0073 30.7248L24.731 25.1103V28.9979C24.7321 29.0177 24.7283 29.0376 24.7199 29.0556C24.7115 29.0736 24.6988 29.0893 24.6829 29.1012L16.6317 33.7497C14.9096 34.7416 12.8643 35.0097 10.9447 34.4954C9.02506 33.9811 7.38785 32.7263 6.39227 31.0064ZM4.29707 13.6194C5.17156 12.0998 6.55279 10.9364 8.19885 10.3327C8.19885 10.4013 8.19491 10.5228 8.19491 10.6071V19.808C8.19351 20.0378 8.25334 20.2638 8.36823 20.4629C8.48312 20.6619 8.64893 20.8267 8.84863 20.9404L18.5723 26.5542L15.206 28.4979C15.1894 28.5089 15.1703 28.5155 15.1505 28.5173C15.1307 28.5191 15.1107 28.516 15.0924 28.5082L7.04046 23.8557C5.32135 22.8601 4.06716 21.2235 3.55289 19.3046C3.03862 17.3858 3.30624 15.3413 4.29707 13.6194ZM31.955 20.0556L22.2312 14.4411L25.5976 12.4981C25.6142 12.4872 25.6333 12.4805 25.6531 12.4787C25.6729 12.4769 25.6928 12.4801 25.7111 12.4879L33.7631 17.1364C34.9967 17.849 36.0017 18.8982 36.6606 20.1613C37.3194 21.4244 37.6047 22.849 37.4832 24.2684C37.3617 25.6878 36.8382 27.0432 35.9743 28.1759C35.1103 29.3086 33.9415 30.1717 32.6047 30.6641C32.6047 30.5947 32.6047 30.4733 32.6047 30.3889V21.188C32.6066 20.9586 32.5474 20.7328 32.4332 20.5338C32.319 20.3348 32.154 20.1698 31.955 20.0556ZM35.3055 15.0128C35.2464 14.9765 35.1431 14.9142 35.069 14.8717L27.1045 10.2712C26.906 10.1554 26.6803 10.0943 26.4504 10.0943C26.2206 10.0943 25.9948 10.1554 25.7963 10.2712L16.0726 15.8858V11.9982C16.0715 11.9783 16.0753 11.9585 16.0837 11.9405C16.0921 11.9225 16.1048 11.9068 16.1207 11.8949L24.1719 7.25025C25.4053 6.53903 26.8158 6.19376 28.2383 6.25482C29.6608 6.31589 31.0364 6.78077 32.2044 7.59508C33.3723 8.40939 34.2842 9.53945 34.8334 10.8531C35.3826 12.1667 35.5464 13.6095 35.3055 15.0128ZM14.2424 21.9419L10.8752 19.9981C10.8576 19.9893 10.8423 19.9763 10.8309 19.9602C10.8195 19.9441 10.8122 19.9254 10.8098 19.9058V10.6071C10.8107 9.18295 11.2173 7.78848 11.9819 6.58696C12.7466 5.38544 13.8377 4.42659 15.1275 3.82264C16.4173 3.21869 17.8524 2.99464 19.2649 3.1767C20.6775 3.35876 22.0089 3.93941 23.1034 4.85067C23.0427 4.88379 22.937 4.94215 22.8668 4.98473L14.9024 9.58517C14.7025 9.69878 14.5366 9.86356 14.4215 10.0626C14.3065 10.2616 14.2466 10.4877 14.2479 10.7175L14.2424 21.9419ZM16.071 17.9991L20.4018 15.4978L24.7325 17.9975V22.9985L20.4018 25.4983L16.071 22.9985V17.9991Z" })
	});
}
//#endregion
...
function ChatGPTMinimalIcon() {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
		...
		children: [
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M12 7v4" }),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("line", {
				x1: "8",
				x2: "8",
				y1: "16",
...
function PaLMinimalIcon({ className = "" }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
		...
		"aria-hidden": "true",
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "m16 30.238c1.2298 0 2.2259-0.99608 2.2259-2.2259v-11.46c-0.63513-0.56429-1.6553-1.6805-2.2259-2.251-0.79858 0.83793-1.3599 1.3599-2.2259 2.251v11.46c0 1.2298 0.99608 2.2259 2.2259 2.2259z" }),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "m24.868 15.761c-0.61691-0.61643-1.3121-1.1065-2.0536-1.4703-6.8147 0.010467 0.13304 0.031026-6.8147 0.010467l9.5286 9.5286c0.39324 0.39324 1.0703 0.23743 1.2372-0.29122 0.83841-2.6544 0.20589-5.6723-1.8976-7.7776z" }),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "m7.1318 15.761c0.5902-0.58975 1.2521-1.0639 1.9575-1.4224 6.9107-0.037427-0.11812-0.057288 6.9107-0.037427l-9.5286 9.5286c-0.39324 0.39324-1.0703 0.23743-1.2372-0.29122-0.83841-2.6543-0.20589-5.6723 1.8976-7.7776z" }),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "m24.162 8.3655c-0.93169 0-1.8288 0.15009-2.6691 0.42772-5.4924 5.5079 0 0-5.4924 5.5079h15.069c0.61767 0 1.0295-0.65292 0.74938-1.2038-1.432-2.8102-4.3219-4.7318-7.657-4.7318z" }),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "m17.575 4.333c-0.62613 0.62613-1.1343 1.3257-1.5248 2.0718 1.6767 4.1174 0.53518 6.3909-0.05003 7.8964l10.656-10.656c0.43775-0.43775 0.2671-1.1908-0.3209-1.3819-3.0012-0.97382-6.4031-0.28751-8.7607 2.0701z" }),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "m14.425 4.333c2.6822 2.6822 3.1997 6.7129 1.5748 9.9682l-10.656-10.656c-0.43775-0.43775-0.2671-1.1908 0.3209-1.3819 3.0012-0.97382 6.4031-0.28751 8.7607 2.0701z" }),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "m7.8385 8.3655c0.9121 0 1.791 0.14385 2.616 0.41037 5.5455 5.5253-0.061773 0.011675 5.5455 5.5253h-15.069c-0.61768 0-1.0295-0.65292-0.74938-1.2038 1.432-2.8102 4.3219-4.7318 7.657-4.7318z" })
		]
	});
}
//#endregion
...
function GoogleMinimalIcon({ className = "" }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
		...
		className: cn("h-4 w-4", className),
		"aria-hidden": "true",
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M473.16,221.48l-2.26-9.59H262.46v88.22H387c-12.93,61.4-72.93,93.72-121.94,93.72-35.66,0-73.25-15-98.13-39.11a140.08,140.08,0,0,1-41.8-98.88c0-37.16,16.7-74.33,41-98.78s61-38.13,97.49-38.13c41.79,0,71.74,22.19,82.94,32.31l62.69-62.36C390.86,72.72,340.34,32,261.6,32h0c-60.75,0-119,23.27-161.58,65.71C58,139.5,36.25,199.93,36.25,256S56.83,369.48,97.55,411.6C141.06,456.52,202.68,480,266.13,480c57.73,0,112.45-22.62,151.45-63.66,38.34-40.4,58.17-96.3,58.17-154.9C475.75,236.77,473.27,222.12,473.16,221.48Z" })
	});
}
//#endregion
...
function AnthropicMinimalIcon() {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
		...
		xmlns: "http://www.w3.org/2000/svg",
		"aria-hidden": "true",
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "m17.304 3.5472h-3.6718l6.6959 16.906h3.6718zm-10.608 0-6.6959 16.906h3.7442l1.3693-3.5502h7.0052l1.3693 3.5502h3.7442l-6.6959-16.906zm-0.37114 10.216 2.2914-5.9413 2.2914 5.9413z" })
	});
}
//#endregion
...
function ListeningIcon({ className }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
		...
		"aria-hidden": "true",
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M12 2a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3Z" }),
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("defs", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("linearGradient", {
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("g", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "m29.476 158.16a12.903 12.903 0 0 0-3.6562 0.5293l-3.3691 23.189a12.903 12.903 0 0 0 7.0254 2.0879 12.903 12.903 0 0 0 12.904-12.904 12.903 12.903 0 0 0-12.904-12.902z" })
				]
			})
		] })]
	});
...
function AssistantIcon({ className = "", size = "1em" }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
		...
		"aria-hidden": "true",
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z" }),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("polyline", { points: "3.27 6.96 12 12.01 20.73 6.96" }),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("line", {
				x1: "12",
				y1: "22.08",
				x2: "12",
...
function SpeechIcon({ className }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
		...
		"aria-hidden": "true",
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M2 10v3" }),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M6 6v11" }),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M10 3v18" }),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M14 8v7" }),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M18 5v13" }),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M22 10v3" })
		]
	});
}
//#endregion
...
function ThumbUpIcon({ className = "", size = "1em", bold = false }) {
	return bold ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
		xmlns: "http://www.w3.org/2000/svg",
		height: size,
		width: size,
		fill: "none",
...
function XAIcon({ className = "" }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
		...
		fill: "currentColor",
		className,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "m3.005 8.858 8.783 12.544h3.904L6.908 8.858zM6.905 15.825 3 21.402h3.907l1.951-2.788zM16.585 2l-6.75 9.64 1.953 2.79L20.492 2zM17.292 7.965v13.437h3.2V3.395z" })
	});
}
//#endregion
...
function FileIcon({ file, fileType }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("rect", {
			...
			rx: "6",
			fill: fileType.fill
		}), (file?.["progress"] ?? 1) >= 1 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_jsx_runtime.Fragment, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(fileType.paths, {}) })]
	});
}
//#endregion
...
function SheetPaths() {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_jsx_runtime.Fragment, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
...
const Avatar = ({ user, size = 32, className = "", alt, showDefaultWhenEmpty = true }) => {
	...
	const avatarSeed = (0, react.useMemo)(() => user?.avatar || user?.username || user?.email || "", [
		user?.avatar,
		user?.username,
		user?.email
	]);
	const altText = (0, react.useMemo)(() => alt || `${user?.name || user?.username || user?.email || ""}'s avatar`, [
		alt,
		user?.name,
		user?.username,
		user?.email
	]);
	const imageSrc = (0, react.useMemo)(() => {
	...
	const handleImageLoad = (0, react.useCallback)(() => {
		setImageLoaded(true);
	}, []);
	const handleImageError = (0, react.useCallback)(() => {
		setImageError(true);
		setImageLoaded(false);
	}, []);
	const DefaultAvatar = (0, react.useCallback)(() => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		style: {
	...
	if (avatarSeed.length === 0 && showDefaultWhenEmpty) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DefaultAvatar, {});
	if (avatarSeed.length > 0 && !imageError) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: "relative",
		style: {
			width: `${size}px`,
			height: `${size}px`
		},
		children: [!imageLoaded && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Skeleton, {
	...
	if (imageError && showDefaultWhenEmpty) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DefaultAvatar, {});
	return null;
};
//#endregion
...
function ComboboxComponent({ selectedValue, displayValue, items, setValue, ariaLabel, searchPlaceholder, selectPlaceholder, isCollapsed, SelectIcon }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_select.Root, {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_ariakit_react.ComboboxProvider, {
			open,
			setOpen,
			...
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SelectTrigger, {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(SelectValue, {
					placeholder: selectPlaceholder,
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: "assistant-item flex items-center justify-center overflow-hidden rounded-full",
						children: SelectIcon ? SelectIcon : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_icons.ChevronDownIcon, {})
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
			...
			}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_select.Portal, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_radix_ui_react_select.Content, {
				role: "dialog",
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_radix_ui_react_select.Viewport, {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.Search, { className: "h-4 w-4 text-text-secondary transition-colors duration-300 group-focus-within:text-text-primary group-hover:text-text-primary" }),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react.Combobox, {
								autoSelect: true,
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react.ComboboxCancel, {
								hideWhenEmpty: true,
					...
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react.ComboboxList, {
						className: "overflow-y-auto p-1 py-2",
						children: matches.map(({ label, value, icon }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_select.Item, {
							value: `${value ?? ""}`,
							asChild: true,
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_ariakit_react.ComboboxItem, {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: "absolute right-2 flex h-3.5 w-3.5 items-center justify-center",
									children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_select.ItemIndicator, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_icons.CheckIcon, { className: "h-4 w-4" }) })
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_select.ItemText, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SelectScrollDownButton, { className: "absolute bottom-0 left-0 right-0" })]
			}) })]
		})
	});
}
...
function SendActions({ anchor, actions, label }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_ariakit_react.HovercardProvider, {
		placement: "top-end",
		showTimeout: 100,
		hideTimeout: 150,
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react.HovercardAnchor, { render: anchor }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react.Hovercard, {
			portal: true,
			gutter: 8,
			unmountOnHide: true,
			"aria-label": label,
			...
			children: actions.map((action) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
				type: "button",
				className: ROW_CLASS,
				...
				children: [
					action.icon,
					action.label,
					action.kbd != null && action.disabled !== true && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Kbd, { children: action.kbd })
				]
			}, action.key))
		})]
	});
...
*/
const Composer = (0, react.forwardRef)(function Composer({ value, onChange, onSubmit, canSubmit, submitLabel, ariaLabel, placeholder, disabled = false, maxLength, minRows = 1, maxRows = 6, actions, submitActions, submitActionsLabel, onStop, stopLabel, submitOnEnter = true, resolveKeyVerdict, className }, ref) {
	...
	*  rather than standing a second control beside it. */
	...
	const sendButton = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
		type: "button",
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SendIcon, { size: 24 })
	});
	const handleKeyDown = (event) => {
		/**
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(TextareaAutosize, {
			ref,
			value,
			...
			*  when this panel is open beside the thread. */
			...
			children: [actions, showStop ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TooltipAnchor, {
			...
			}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SendActions, {
				actions: offeredActions,
				label: submitActionsLabel ?? submitLabel,
				anchor: offeredActions.length > 0 ? sendButton : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TooltipAnchor, {
...
const Dropdown = ({ value: selectedValue, label = "", onChange, options, className = "", triggerClassName, sizeClasses, testId = "dropdown-menu", icon, iconOnly = false, renderValue, ariaLabel, "aria-labelledby": ariaLabelledBy, portal = true, variant = "default", portalElement, disabled = false, searchable = false, searchPlaceholder, searchEmptyText }) => {
	const valueId = `${(0, react.useId)()}value`;
	const [searchValue, setSearchValue] = (0, react.useState)("");
	const handleChange = (value) => {
		onChange(value);
	};
	const comboboxStore = _ariakit_react_combobox.useComboboxStore({
		resetValueOnHide: true,
		value: searchValue,
		setValue: setSearchValue
	});
	const selectProps = _ariakit_react_select.useSelectStore({
	...
	const matches = (0, react.useMemo)(() => {
		...
		return (0, match_sorter.matchSorter)(options.filter((o) => !isDivider(o)).map((o) => normalizeOption(o)), searchValue, {
			keys: ["label", "value"],
	...
	const renderOptionContent = (option) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: "flex w-full items-center gap-2",
		children: [
			option.icon != null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: option.icon }),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				className: "block truncate",
				children: option.label
			}),
			selectedValue === option.value && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_ariakit_react_select.Select, {
			store: selectProps,
			disabled,
			className: cn(
			...
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [icon, !iconOnly && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
					id: valueId,
					className: "block truncate",
					children: [label, (() => {
			...
			}), !iconOnly && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react_select.SelectArrow, {})]
		}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react_select.SelectPopover, {
			portal,
			portalElement,
			store: selectProps,
			className: cn("popover-ui z-40 text-sm", "[pointer-events:auto]", sizeClasses),
			children: searchable ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.Search, {
							...
							"aria-hidden": "true"
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react_combobox.Combobox, {
							store: comboboxStore,
							autoSelect: true,
							placeholder: searchPlaceholder,
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react_combobox.ComboboxList, {
					store: comboboxStore,
					"aria-label": ariaLabel,
					"aria-labelledby": ariaLabelledBy,
					className: "flex flex-col",
					children: matches.map((option) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react_combobox.ComboboxItem, {
						value: String(option.value),
						className: "select-item",
						render: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react_select.SelectItem, {
							value: String(option.value),
				...
				if (isDivider(item)) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { className: "my-1 border-t border-border-heavy" }, `divider-${index}`);
				const option = normalizeOption(item);
				if (!isOption(option)) return null;
				return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react_select.SelectItem, {
					value: String(option.value),
					className: "select-item",
					"data-theme": option.value,
					children: renderOptionContent(option)
		...
		children: [
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.Search, { className: cn(`h-4 w-4 transition-all duration-500 ease-in-out`, isSearching && hasValue ? "text-accent-primary" : "text-text-secondary") })
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
							type: "text",
							value,
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { className: `pointer-events-none absolute inset-0 z-20 rounded-lg bg-gradient-to-r from-accent-primary/20 via-accent-primary/10 to-accent-primary/20 transition-all duration-500 ease-in-out ${isSearching && hasValue ? "opacity-100 blur-sm" : "opacity-0 blur-none"} ` }),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { className: "absolute inset-0 animate-ping rounded-full bg-accent-primary/60" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { className: "absolute inset-0 rounded-full bg-accent-primary" })]
							})
						})
					]
				})
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { className: `bg-gradient-radial absolute inset-0 from-accent-primary/10 to-transparent transition-opacity duration-700 ease-in-out ${isSearching && hasValue ? "animate-pulse-slow opacity-100" : "opacity-0"} ` }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { className: `absolute inset-0 bg-gradient-to-r from-accent-primary/5 via-accent-primary/10 to-accent-primary/5 blur-xl transition-all duration-700 ease-in-out ${isSearching && hasValue ? "animate-gradient-x opacity-100" : "opacity-0"} ` })]
				})
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { className: `absolute inset-0 -z-20 scale-100 bg-gradient-to-r from-accent-primary/10 via-accent-primary/10 to-accent-primary/10 opacity-0 blur-xl transition-all duration-500 ease-in-out peer-focus:scale-105 peer-focus:opacity-100` })
		]
	});
};
//#endregion
//#region src/components/DataTable.tsx
const SelectionCheckbox$1 = (0, react.memo)(({ checked, onChange, ariaLabel }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
	role: "button",
	tabIndex: 0,
...
const TableRowComponent$1 = ({ row, isSmallScreen, onSelectionChange, index, isSearching }) => {
	const handleSelection = (0, react.useCallback)((value) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TableRow, {
		...
		children: row.getVisibleCells().map((cell) => {
			if (cell.column.id === "select") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TableCell, {
				className: "px-2 py-1 transition-all duration-300",
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SelectionCheckbox$1, {
					checked: row.getIsSelected(),
					onChange: handleSelection,
					ariaLabel: "Select row"
				})
			}, cell.id);
			if (cell.column.id === "title") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TableHead, {
...
const MemoizedTableRow$1 = (0, react.memo)(TableRowComponent$1);
...
const DeleteButton = (0, react.memo)(({ onDelete, isDeleting, disabled, isSmallScreen, ariaLabel }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Button, {
		...
		"aria-label": ariaLabel,
		children: isDeleting ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Spinner, { className: "size-4" }) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(TrashIcon, { className: "size-3.5 text-text-destructive sm:size-4" }), !isSmallScreen && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
			className: "ml-2",
			children: "Delete"
		})] })
	});
...
function DataTable({ columns, data, onDelete, filterColumn, defaultSort = [], className = "", isFetchingNextPage = false, hasNextPage = false, fetchNextPage, enableRowSelection = true, showCheckboxes = true, onFilterChange, filterValue, isLoading, enableSearch = true }) {
	...
	const [sorting, setSorting] = (0, react.useState)(defaultSort);
	const [columnFilters, setColumnFilters] = (0, react.useState)([]);
	const [columnVisibility, setColumnVisibility] = (0, react.useState)({});
	const [searchTerm, setSearchTerm] = (0, react.useState)(filterValue ?? "");
	const [isSearching, setIsSearching] = (0, react.useState)(false);
	const [searchResultsAnnouncement, setSearchResultsAnnouncement] = (0, react.useState)("");
	const tableColumns = (0, react.useMemo)(() => {
		...
		return [{
			...
			cell: ({ row }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SelectionCheckbox$1, {
				checked: row.getIsSelected(),
	...
	const rowVirtualizer = (0, _tanstack_react_virtual.useVirtualizer)({
		...
		estimateSize: (0, react.useCallback)(() => 48, []),
		overscan: 10
	});
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [enableRowSelection && showCheckboxes && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DeleteButton, {
					onDelete: handleDelete,
					isDeleting,
					disabled: !table.getFilteredSelectedRowModel().rows.length || isDeleting,
					isSmallScreen,
					ariaLabel: localize("com_ui_delete_selected_items")
				}), filterColumn !== void 0 && table.getColumn(filterColumn) && enableSearch && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					className: "relative flex-1",
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(AnimatedSearchInput, {
						value: searchTerm,
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Table, {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(TableHeader, {
						...
						children: table.getHeaderGroups().map((headerGroup) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TableRow, {
							...
							children: headerGroup.headers.map((header) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TableHead, {
						...
						paddingTop > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("tr", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", { style: { height: `${paddingTop}px` } }) }),
						isLoading && skeletons,
						virtualRows.map((virtualRow) => {
							const row = rows[virtualRow.index];
							return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MemoizedTableRow$1, {
								row,
								isSmallScreen,
						...
						!virtualRows.length && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TableRow, {
						...
						paddingBottom > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("tr", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", { style: { height: `${paddingBottom}px` } }) }),
						(isFetchingNextPage || hasNextPage) && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TableRow, {
							className: "hover:bg-transparent",
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TableCell, {
								colSpan: columns.length,
								className: "p-4",
								children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									...
									children: isFetchingNextPage ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Spinner, { className: "size-4" }) : hasNextPage && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { className: "h-6" })
								})
							})
						})
					] })]
...
const SplitText = ({ text = "", className = "", delay = 100, animationFrom = {
	...
	const animatedCount = (0, react.useRef)(0);
	const [springs] = (0, _react_spring_web.useSprings)(letters.length, (i) => ({
		from: animationFrom,
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
		...
		"aria-hidden": "true",
		children: words.map((word, wordIndex) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
			style: {
			...
			children: [word.map((letter, letterIndex) => {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_react_spring_web.animated.span, {
					style: springs[index],
					className: "inline-block transform transition-opacity will-change-transform",
					children: letter
				}, index);
			}), wordIndex < words.length - 1 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				style: {
					display: "inline-block",
					width: "0.3em"
				},
...
function PixelCard({ variant = "default", gap, speed, colors, noFocus, className = "", progress, randomness = .3, width, height }) {
	...
	const pixelsRef = (0, react.useRef)([]);
	const animationRef = (0, react.useRef)(void 0);
	const timePrevRef = (0, react.useRef)(performance.now());
	const progressRef = (0, react.useRef)(progress);
	const reducedMotion = (0, react.useRef)(window.matchMedia("(prefers-reduced-motion: reduce)").matches).current;
	const cfg = VARIANTS[variant];
	const g = gap ?? cfg.gap;
	const s = speed ?? cfg.speed;
	const palette = colors ?? cfg.colors;
	const disableFocus = noFocus ?? cfg.noFocus;
	const updateCanvasOpacity = (0, react.useCallback)(() => {
	...
	const animate = (0, react.useCallback)((method) => {
	...
	const startAnim = (0, react.useCallback)((m) => {
		cancelAnimationFrame(animationRef.current);
		animationRef.current = requestAnimationFrame(() => animate(m));
	}, [animate]);
	const initPixels = (0, react.useCallback)(() => {
...
const FileUpload = (0, react.forwardRef)(({ children, handleFileChange }, ref) => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [children, /* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
		ref,
		multiple: true,
		type: "file",
		style: { display: "none" },
...
function MultiSelect({ items, label, placeholder = "Select...", onSelectedValuesChange, renderSelectedValues = defaultRender, className, selectIcon, itemClassName, labelClassName, selectClassName, popoverClassName, selectItemsClassName, selectedValues = [], setSelectedValues, renderItemContent, popoverHeader, searchPlaceholder, searchEmptyText, disabled = false, showSelectedValues = false, showItemCheckboxes = false, onOpenChange }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_ariakit_react.SelectProvider, {
			value: selectedValues,
			setValue: handleValueChange,
			open: isPopoverOpen,
			setOpen: handleOpenChange,
			children: [
				label && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react.SelectLabel, {
					className: cn("mb-1 block text-sm text-text-primary", labelClassName),
					children: label
				}),
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_ariakit_react.Select, {
					ref: selectRef,
					disabled,
					...
					children: [
						selectIcon && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: selectIcon }),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react.SelectArrow, { className: cn("ml-1 stroke-1 text-base opacity-75 transition-transform duration-300", !showSelectedValues && "hidden md:block", isPopoverOpen && "rotate-180") })
					]
				}),
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_ariakit_react.SelectPopover, {
					role: "dialog",
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: "shrink-0",
							children: [searchPlaceholder && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react.SelectList, {
							className: "min-h-0 overflow-y-auto overscroll-contain",
							children: visibleItems.map((item) => {
								const value = getItemValue(item);
								const label = getItemLabel(item);
								const isCurrentItemSelected = selectedValues.includes(value);
								const defaultContent = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [showItemCheckboxes ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									"aria-hidden": "true",
									...
									children: isCurrentItemSelected && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.Check, {
										className: "size-3.5",
										strokeWidth: 2
									})
								}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react.SelectItemCheck, { className: "mr-0.5 text-text-primary" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: "truncate",
									children: label
								})] });
								return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react.SelectItem, {
									value,
									"aria-label": label,
						...
						visibleItems.length === 0 && searchEmptyText && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							role: "status",
...
const DropdownPopup = ({ trigger, isOpen, setIsOpen, focusLoop, mountByState, ...props }) => {
	const menu = _ariakit_react.useMenuStore({
		open: isOpen,
		setOpen: setIsOpen,
		focusLoop
	});
	if (mountByState) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_ariakit_react.MenuProvider, {
		store: menu,
		children: [trigger, isOpen && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Menu, { ...props })]
	});
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_ariakit_react.MenuProvider, {
		store: menu,
		children: [trigger, /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Menu, { ...props })]
	});
};
const Menu = ({ items, menuId, keyPrefix, className, iconClassName, itemClassName, modal, portal, sameWidth, gutter = 8, finalFocus, unmountOnHide, preserveTabOrder, style, ...props }) => {
	const menuStore = _ariakit_react.useMenuStore();
	const menu = _ariakit_react.useMenuContext();
	const zIndex = usePopoverZIndex();
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react.Menu, {
		id: menuId,
		modal,
		gutter,
		portal,
		...
		children: items.filter((item) => item.show !== false).map((item, index) => {
			const { subItems } = item;
			if (item.separate === true) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react.MenuSeparator, { className: "my-1 h-px border-border-medium" }, index);
			if (subItems && subItems.length > 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_ariakit_react.MenuProvider, {
				store: menuStore,
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_ariakit_react.MenuButton, {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						...
						children: [item.icon != null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: cn("mr-2 size-4", iconClassName),
							"aria-hidden": "true",
							children: item.icon
						}), item.label]
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react.MenuButtonArrow, { className: "stroke-1 text-base opacity-75" })]
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_ariakit_react.MenuItem, {
				id: item.id,
				...
				children: [
					item.icon != null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: cn("mr-2 size-4", iconClassName),
						"aria-hidden": "true",
						children: item.icon
					}),
					item.label,
					item.kbd != null && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("kbd", {
...
function ThemeProvider({ children, themeRGB: propThemeRGB, themeDefinition: propThemeDefinition, persistThemeDefinition = true, themeName: propThemeName, initialTheme }) {
	const initialThemeState = (0, react.useRef)(void 0);
	...
	const [theme, setThemeState] = (0, react.useState)(initialAppearance);
	/**
	...
	*/
	const [resolvedMode, setResolvedMode] = (0, react.useState)(initialAppearance !== "system" && isDark(initialAppearance) ? "dark" : "light");
	const [highContrast, setHighContrast] = (0, react.useState)(isHighContrast(initialAppearance));
	const [themeDefinition, setThemeDefinitionState] = (0, react.useState)(initialThemeState.current.definition);
	const [legacyThemeRGB, setLegacyThemeRGB] = (0, react.useState)(initialThemeState.current.legacyColors);
	const legacyThemeRGBRef = (0, react.useRef)(legacyThemeRGB);
	legacyThemeRGBRef.current = legacyThemeRGB;
	const themeDefinitionRef = (0, react.useRef)(themeDefinition);
	themeDefinitionRef.current = themeDefinition;
	const [themeName, setThemeNameState] = (0, react.useState)(themeDefinition?.name ?? propThemeName ?? getInitialThemeName);
	const themeNameRef = (0, react.useRef)(themeName);
	themeNameRef.current = themeName;
	const persistedInitialProps = (0, react.useRef)(false);
	const previousThemeProps = (0, react.useRef)({
		initialTheme,
		themeDefinition: propThemeDefinition,
		themeName: propThemeName,
		themeRGB: propThemeRGB
	});
	const controlledThemeActive = (0, react.useRef)(Boolean(propThemeDefinition && isValidThemeDefinition(propThemeDefinition) || !propThemeDefinition && propThemeRGB));
	const synchronizedThemeProps = (0, react.useRef)(false);
	const themeDOMSnapshot = (0, react.useRef)(void 0);
	const themeClassSnapshot = (0, react.useRef)(void 0);
	const writeThemeStorage = (0, react.useCallback)((key, value) => {
		if (!persistThemeDefinition) return;
		writeStorage(key, value);
	}, [persistThemeDefinition]);
	const restoreAppliedTheme = (0, react.useCallback)((root = window.document.documentElement) => {
		if (!themeDOMSnapshot.current) return;
		restoreThemeDOM(themeDOMSnapshot.current, root);
		themeDOMSnapshot.current = void 0;
	}, []);
	const prepareThemeDOM = (0, react.useCallback)((root) => {
	...
	const setTheme = (0, react.useCallback)((newTheme) => {
		if (!isAppearanceMode(newTheme)) return;
		setThemeState(newTheme);
		writeStorage(THEME_KEY, newTheme);
	}, []);
	const setThemeDefinition = (0, react.useCallback)((definition) => {
	...
	const setThemeRGB = (0, react.useCallback)((colors) => {
	...
	const setThemeName = (0, react.useCallback)((name) => {
	...
	const applyThemeMode = (0, react.useCallback)((currentTheme) => {
	...
	const resetTheme = (0, react.useCallback)(() => {
		setTheme("system");
		setThemeDefinition(void 0);
		writeThemeStorage(THEME_COLORS_KEY);
		restoreAppliedTheme();
...
*/
const themeModeAtom = (0, jotai_utils.atomWithStorage)("color-theme", "system", void 0, { getOnInit: true });
/**
* @deprecated Use ThemeContext instead. This atom is no longer used internally.
*/
const themeColorsAtom = (0, jotai_utils.atomWithStorage)("theme-colors", void 0, void 0, { getOnInit: true });
/**
* @deprecated Use ThemeContext instead. This atom is no longer used internally.
*/
const themeNameAtom = (0, jotai_utils.atomWithStorage)("theme-name", void 0, void 0, { getOnInit: true });
//#endregion
...
const themeIcons = {
	...
	dark: lucide.Moon,
	light: lucide.Sun,
	"high-contrast-light": lucide.Sun,
	"high-contrast-dark": lucide.Moon
};
...
const ThemeSelector = ({ returnThemeOnly }) => {
	const { theme, highContrast, setTheme } = (0, react.useContext)(ThemeContext);
	const [announcement, setAnnouncement] = (0, react.useState)("");
	const localize = useLocalize();
	const changeTheme = (0, react.useCallback)((value, control) => {
		const now = Date.now();
	...
	const changeScheme = (0, react.useCallback)((value) => changeTheme(value, "scheme"), [changeTheme]);
	const changeContrast = (0, react.useCallback)((value) => changeTheme(value, "contrast"), [changeTheme]);
	(0, react.useEffect)(() => {
		if (announcement) {
	...
	if (returnThemeOnly === true) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Theme, {
		theme,
		highContrast,
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Theme, {
				...
				highContrast,
				onChange: changeScheme
			}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ContrastToggle, {
				theme,
				highContrast,
...
const InfoHoverCard = ({ side, text, icon = "help", children }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(HoverCard, {
		openDelay: 50,
		open: isOpen,
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(HoverCardTrigger, {
			...
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				...
				"aria-label": text,
				children: children ?? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(icon === "info" ? lucide_react.InfoIcon : lucide_react.CircleHelpIcon, {
...
const CheckboxButton = react.forwardRef(({ icon, label, setValue, className, checked, defaultChecked, isCheckedClassName }, ref) => {
	const checkbox = (0, _ariakit_react.useCheckboxStore)();
	const isChecked = (0, _ariakit_react.useStoreState)(checkbox, (state) => state?.value);
	const onChange = (e) => {
		e.stopPropagation();
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_ariakit_react.Checkbox, {
		ref,
		store: checkbox,
		onChange,
...
const DialogTemplate = (0, react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(DialogContent, {
		showCloseButton,
		ref,
		...
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(DialogHeader, {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(DialogTitle, {
					className: "text-lg font-medium leading-6 text-text-primary",
					children: title
				}), description && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DialogDescription, {
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(DialogFooter, {
				className: footerClassName,
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { children: leftButtons ? leftButtons : null }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: "flex h-auto gap-3",
					children: [
						showCancelButton && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DialogClose, {
							className: "border-border-light hover:bg-surface-hover",
							children: "cancel"
						}),
						buttons ? buttons : null,
						selection ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DialogClose, {
...
function SelectDropDown({ title: _title, value, disabled, setValue, availableValues, showAbove = false, showLabel = true, emptyTitle = false, iconSide = "right", optionIconSide = "left", placeholder, containerClassName, optionsListClass, optionsClass, currentValueClass, subContainerClassName, className, renderOption, searchClassName, searchPlaceholder, showOptionIcon = false }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_headlessui_react.Listbox, {
				value,
				onChange: setValue,
				disabled,
				children: ({ open }) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_headlessui_react.ListboxButton, {
					ref: buttonRef,
					...
					children: [
						showLabel && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_headlessui_react.Label, {
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							...
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								...
								children: [
									!showLabel && !emptyTitle && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
										className: "text-xs text-text-secondary",
										children: [title, ":"]
									}),
									renderIcon && optionIconSide !== "right" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "icon-md flex items-center",
										children: value.icon
									}),
									renderIcon && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "icon-md absolute right-0 mr-8 flex items-center",
										children: value.icon
									}),
									(() => {
										if (!value) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											className: "text-text-secondary",
				...
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_headlessui_react.Transition, {
					show: open,
					as: "div",
					...
					leaveTo: "opacity-0",
					...transitionProps,
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_headlessui_react.ListboxOptions, {
						...
						children: [
							renderOption && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_headlessui_react.ListboxOption, {
								value: null,
							...
							options.map((option, i) => {
								...
								return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_headlessui_react.ListboxOption, {
									value: option,
...
function ControlCombobox({ selectedValue, displayValue, items, setValue, onBlur, ariaLabel, ariaInvalid, ariaDescribedBy, searchPlaceholder, selectPlaceholder, containerClassName, isCollapsed, SelectIcon, showCarat, className, disabled, iconClassName, iconSide = "left", selectId, placement, popoverClassName, matchTriggerWidth = true, variant = "default", gutter = 4, portal = true, onOpenChange }) {
	const [searchValue, setSearchValue] = (0, react.useState)("");
	const buttonRef = (0, react.useRef)(null);
	const [buttonWidth, setButtonWidth] = (0, react.useState)(null);
	const popoverZIndex = usePopoverZIndex();
	...
	const combobox = _ariakit_react.useComboboxStore({
		defaultItems: items.map(getItem),
		resetValueOnHide: true,
		value: searchValue,
		setValue: setSearchValue
	});
	const select = _ariakit_react.useSelectStore({
		combobox,
		defaultItems: items.map(getItem),
		value: selectedValue,
		setValue,
	...
	const matches = (0, react.useMemo)(() => {
		return (0, match_sorter.matchSorter)(items, searchValue, {
			keys: ["value", "label"],
			baseSort: (a, b) => a.index < b.index ? -1 : 1
		}).map(getItem);
	}, [searchValue, items]);
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react.SelectLabel, {
				store: select,
				className: "sr-only",
				children: ariaLabel
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_ariakit_react.Select, {
				...
				children: [SelectIcon != null && iconSide === "left" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					SelectIcon != null && iconSide === "right" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: selectIconClassName,
						children: SelectIcon
					}),
					showCarat && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.ChevronDown, { className: "h-4 w-4 text-text-secondary" })
				] })]
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_ariakit_react.SelectPopover, {
				store: select,
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "relative",
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.Search, { className: "absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-text-primary" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react.Combobox, {
							store: combobox,
							autoSelect: true,
							placeholder: searchPlaceholder,
					...
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react.ComboboxList, {
						store: combobox,
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react_components_select_select_renderer.SelectRenderer, {
							store: select,
							items: matches,
							itemSize: ROW_HEIGHT,
							overscan: 5,
							children: ({ value, icon, label, ...item }) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_ariakit_react.ComboboxItem, {
								...item,
								...
								render: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_ariakit_react.SelectItem, { value }),
								children: [
									icon != null && iconSide === "left" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									...
									icon != null && iconSide === "right" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
										className: optionIconClassName,
										children: icon
									})
								]
...
const ControlComboboxMemo = (0, react.memo)(ControlCombobox);
//#endregion
...
function EmptyState({ icon: Icon, title, description, action, className }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			title != null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
			...
			action != null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: "mt-3",
				children: action
			})
		]
...
function TimeColumn({ label, values, selected, format, onSelect }) {
	...
	*  row they just aimed at back to the middle. */
	const initialSelected = (0, react.useRef)(selected);
	/**
...
function PickerShell({ id, labelledBy, className, display, contentClassName, children }) {
	const [open, setOpen] = (0, react.useState)(false);
	const valueId = `${(0, react.useId)()}value`;
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_radix_ui_react_popover.Root, {
		open,
		onOpenChange: setOpen,
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_popover.Trigger, {
			asChild: true,
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					...
					children: display
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.Clock, {
					className: "size-4 shrink-0 text-text-secondary",
					"aria-hidden": "true"
				})]
			})
		}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_popover.Content, {
			side: "bottom",
			align: "start",
			sideOffset: 6,
...
function TimePicker({ hour, minute, onChange, labels, id, labelledBy, className, locale, hour12 }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PickerShell, {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)(TimeColumn, {
					label: labels.hour,
				...
				hour12 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TimeColumn, {
...
function MinutePicker({ minute, onChange, label, id, labelledBy, className }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PickerShell, {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TimeColumn, {
			label,
			values: MINUTES,
			selected: minute,
			format: pad,
...
function isSelectionProps(selection) {
	return typeof selection === "object" && selection !== null && !(0, react.isValidElement)(selection) && ("selectHandler" in selection || "selectClasses" in selection || "selectText" in selection || "isLoading" in selection);
}
const OGDialogTemplate = (0, react.forwardRef)((props, ref) => {
	const localize = useLocalize();
	...
	if (isLegacySelection) selectionContent = /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DialogClose$1, {
		onClick: selectHandler,
		disabled: isLoading,
		...
		children: isLoading === true ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Spinner, { className: "size-4 text-text-primary" }) : selectText
	});
	else if (selection) selectionContent = selection;
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(DialogContent$1, {
		overlayClassName,
		showCloseButton,
		ref,
		className: cn(
		...
		onClick: (e) => e.stopPropagation(),
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(DialogHeader$1, {
				className: cn(headerClassName ?? ""),
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(DialogTitle$1, { children: title }), description && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DialogDescription$1, {
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(DialogFooter$1, {
				className: footerClassName,
				children: [
					leftButtons != null ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: "mr-auto flex flex-row gap-2",
						children: leftButtons
					}) : null,
					showCancelButton && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DialogClose$1, {
						asChild: true,
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Button, {
							variant: "outline",
...
const SelectionCheckbox = (0, react.memo)(({ checked, onChange, ariaLabel }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
...
const TableRowComponent = ({ row, virtualIndex, style, selected }, ref) => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TableRow, {
		...
		children: row.getVisibleCells().map((cell) => {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(isRowHeader ? TableRowHeader : TableCell, {
...
const ForwardTableRowComponent = (0, react.forwardRef)(TableRowComponent);
const MemoizedTableRow = (0, react.memo)(ForwardTableRowComponent, (prev, next) => prev.row.original === next.row.original && prev.selected === next.selected && prev.cellsVersion === next.cellsVersion);
const SkeletonRows = (0, react.memo)(({ count = 10, columns, rowHeight = 40 }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_jsx_runtime.Fragment, { children: Array.from({ length: count }, (_, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TableRow, {
	...
	children: columns.map((column) => {
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TableCell, {
			...
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Skeleton, { className: "h-6 w-full" })
		}, columnKey);
	})
}, `skeleton-${index}`)) }));
...
const useOptimizedRowSelection = (initialSelection = {}) => {
	const [selection, setSelection] = (0, react.useState)(initialSelection);
	return [selection, setSelection];
};
//#endregion
//#region src/components/DataTable/DataTableSearch.tsx
const DataTableSearch = (0, react.memo)(({ value, onChange, placeholder, className, disabled = false }) => {
	const localize = useLocalize();
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Input, {
				...
				value,
				onChange: (e) => {
					(0, react.startTransition)(() => onChange(e.target.value));
				},
				disabled,
...
function DataTable$1({ columns, data, getRowId: getRowIdProp, className = "", isLoading = false, isFetching = false, config, filterValue = "", onFilterChange, defaultSort = [], isFetchingNextPage = false, hasNextPage = false, fetchNextPage, sorting, onSortingChange, customActionsRenderer }) {
	...
	const isSmallScreen = useMediaQuery("(max-width: 768px)");
	const tableContainerRef = (0, react.useRef)(null);
	const scrollTimeoutRef = (0, react.useRef)(null);
	...
	const [dynamicOverscan, setDynamicOverscan] = (0, react.useState)(overscan);
	const lastScrollTopRef = (0, react.useRef)(0);
	const lastScrollTimeRef = (0, react.useRef)(performance.now());
	const fastScrollTimeoutRef = (0, react.useRef)(null);
	const autoFillRowCountRef = (0, react.useRef)(-1);
	const cellsVersionRef = (0, react.useRef)(0);
	const renderedColumnsRef = (0, react.useRef)(columns);
	if (renderedColumnsRef.current !== columns) {
		renderedColumnsRef.current = columns;
		cellsVersionRef.current += 1;
	}
	const [autoFillAttempt, setAutoFillAttempt] = (0, react.useState)(0);
	(0, react.useEffect)(() => {
	...
	const [searchTerm, setSearchTerm] = (0, react.useState)(filterValue);
	const [internalSorting, setInternalSorting] = (0, react.useState)(defaultSort);
	const selectedCount = Object.keys(optimizedRowSelection).length;
	const isAllSelected = (0, react.useMemo)(() => data.length > 0 && selectedCount === data.length, [data.length, selectedCount]);
	const isIndeterminate = selectedCount > 0 && !isAllSelected;
	const getRowId = (0, react.useCallback)((row, index) => getRowIdProp?.(row, index ?? 0) ?? String(row.id ?? row._id ?? `row-${index ?? 0}`), [getRowIdProp]);
	...
	const cleanupTimers = (0, react.useCallback)(() => {
	...
	const sortKey = (0, react.useMemo)(() => finalSorting.map((sort) => `${sort.id}:${sort.desc ? "desc" : "asc"}`).join(","), [finalSorting]);
	const calculatedVisibility = (0, react.useMemo)(() => {
		const newVisibility = {};
		columns.forEach((col) => {
	...
	const hasWarnedAboutMissingIds = (0, react.useRef)(false);
	(0, react.useEffect)(() => {
	...
	const getItemKey = (0, react.useCallback)((index) => getRowId(data[index], index), [data, getRowId]);
	const estimateSize = (0, react.useCallback)(() => rowHeight, [rowHeight]);
	const rowVirtualizer = (0, _tanstack_react_virtual.useVirtualizer)({
	...
	if (showSkeletons) tableBodyContent = /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SkeletonRows, {
		count: skeletonCount,
		rowHeight,
		columns: tableColumns
	});
	else if (virtualizationActive) tableBodyContent = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
		paddingTop > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TableRow, {
			"aria-hidden": "true",
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TableCell, {
		...
		virtualRows.map((virtualRow) => {
			const row = rows[virtualRow.index];
			if (!row) return null;
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MemoizedTableRow, {
				row,
		...
		paddingBottom > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TableRow, {
			"aria-hidden": "true",
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TableCell, {
				colSpan: tableColumns.length,
				style: {
	...
	else tableBodyContent = rows.map((row) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MemoizedTableRow, {
		row,
	...
	*/
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [showToolbar && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			className: "flex w-full shrink-0 items-center gap-2 border-b border-border-light pr-2 md:gap-3",
			children: [shouldShowSearch && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DataTableSearch, {
				value: searchTerm,
			...
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Table, {
				...
				unwrapped: true,
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(TableHeader, { children: headerGroups.map((headerGroup) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TableRow, {
					className: "border-0 hover:bg-transparent",
					children: headerGroup.headers.map((header) => {
						...
						const renderedHeader = header.isPlaceholder ? null : (0, _tanstack_react_table.flexRender)(header.column.columnDef.header, header.getContext());
						let headerContent;
						if (isSelectHeader) headerContent = renderedHeader;
						else if (canSort) headerContent = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Button, {
							type: "button",
							variant: "ghost",
							...
							children: [renderedHeader, /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								"aria-hidden": "true",
								children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(morphicons_react.MorphIcon, {
									icon: {
										asc: lucide.ArrowUp,
										desc: lucide.ArrowDown
									}[header.column.getIsSorted()] ?? lucide.ArrowDownUp,
									className: cn("size-3.5", !sortDirection && "opacity-0 transition-opacity group-hover:opacity-100 group-focus-visible:opacity-100")
								})
							})]
						});
						else headerContent = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				}, headerGroup.id)) }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(TableBody, { children: [tableBodyContent, isFetchingNextPage && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TableRow, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TableCell, {
					colSpan: tableColumns.length,
					className: "p-4 text-center",
					id: "loading-status",
					role: "status",
			...
			}), !isLoading && !showSkeletons && rows.length === 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					...
					children: searchTerm ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.SearchX, {
						className: "size-5",
						"aria-hidden": "true"
					}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.Inbox, {
						className: "size-5",
						"aria-hidden": "true"
					})
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Label, {
...
const providerIcons = {
	[librechat_data_provider.ProviderId.openai]: {
	...
	[librechat_data_provider.ProviderId.anthropic]: {
		art: component(AnthropicIcon),
		label: "Anthropic",
		mono: true,
		brandColor: "var(--provider-anthropic, #d09a74)"
	},
	[librechat_data_provider.ProviderId.google]: {
		art: component(GoogleMinimalIcon),
		label: "Google",
		mono: true,
		byModel: googleByModel
	},
	[librechat_data_provider.ProviderId.azure]: {
		art: component(AzureMinimalIcon),
		label: "Azure OpenAI",
		mono: true,
		brandColor: "var(--provider-azure, linear-gradient(0.375turn, #61bde2, #4389d0))"
	},
	[librechat_data_provider.ProviderId.bedrock]: {
		art: component(BedrockIcon),
		label: "AWS Bedrock",
		mono: true,
		brandColor: "var(--provider-bedrock, #268672)"
	},
	[librechat_data_provider.ProviderId.xai]: {
		art: component(XAIcon),
		label: "xAI",
		mono: true
	},
	[librechat_data_provider.ProviderId.moonshot]: {
		art: component(MoonshotIcon),
		label: "Moonshot",
		mono: true
	},
	[librechat_data_provider.ProviderId.anyscale]: {
		art: asset("assets/anyscale.png"),
		label: "Anyscale"
	},
	[librechat_data_provider.ProviderId.apipie]: {
		art: asset("assets/apipie.png"),
		label: "APIpie"
	},
	[librechat_data_provider.ProviderId.cohere]: {
		art: asset("assets/cohere.png"),
		label: "Cohere"
	},
	[librechat_data_provider.ProviderId.deepseek]: {
		art: asset("assets/deepseek.svg"),
		label: "DeepSeek"
	},
	[librechat_data_provider.ProviderId.fireworks]: {
		art: asset("assets/fireworks.png"),
		label: "Fireworks"
	},
	[librechat_data_provider.ProviderId.groq]: {
		art: asset("assets/groq.png"),
		label: "Groq"
	},
	[librechat_data_provider.ProviderId.helicone]: {
		art: asset("assets/helicone.svg"),
		label: "Helicone"
	},
	[librechat_data_provider.ProviderId.huggingface]: {
		art: asset("assets/huggingface.svg"),
		label: "Hugging Face"
	},
	[librechat_data_provider.ProviderId.lemonade]: {
		art: asset("assets/lemonade.png"),
		label: "AMD Lemonade"
	},
	[librechat_data_provider.ProviderId.mistral]: {
		art: asset("assets/mistral.png"),
		label: "Mistral"
	},
	[librechat_data_provider.ProviderId.mlx]: {
		art: asset("assets/mlx.png"),
		label: "MLX"
	},
	[librechat_data_provider.ProviderId.ollama]: {
		art: asset("assets/ollama.png"),
		label: "Ollama"
	},
	[librechat_data_provider.ProviderId.openrouter]: {
		art: asset("assets/openrouter.png"),
		label: "OpenRouter"
	},
	[librechat_data_provider.ProviderId.perplexity]: {
		art: asset("assets/perplexity.png"),
		label: "Perplexity"
	},
	[librechat_data_provider.ProviderId.qwen]: {
		art: asset("assets/qwen.svg"),
		label: "Qwen"
	},
	[librechat_data_provider.ProviderId.shuttleai]: {
		art: asset("assets/shuttleai.png"),
		label: "ShuttleAI"
	},
	[librechat_data_provider.ProviderId.together]: {
		art: asset("assets/together.png"),
		label: "Together AI"
	},
	[librechat_data_provider.ProviderId.unify]: {
		art: asset("assets/unify.webp"),
		label: "Unify"
	},
	[librechat_data_provider.ProviderId.vercel]: {
...
const ProviderIcon = (0, react.memo)(ProviderIconComponent);
//#endregion
...
const ProviderAvatar = (0, react.memo)(ProviderAvatarComponent);
//#endregion
//#region src/Providers/ToastContext.tsx
const ToastContext = (0, react.createContext)({ showToast: () => ({}) });
...
exports.AnimatedSearchInput = AnimatedSearchInput;
exports.AnimatedTabs = AnimatedTabs;
exports.AnthropicIcon = AnthropicIcon;
exports.AnthropicMinimalIcon = AnthropicMinimalIcon;
...
exports.AudioPaths = AudioPaths;
exports.Avatar = Avatar;
exports.AzureMinimalIcon = AzureMinimalIcon;
exports.Badge = Badge;
exports.BedrockIcon = BedrockIcon;
...
exports.ChatGPTMinimalIcon = ChatGPTMinimalIcon;
exports.CheckMark = CheckMark;
exports.Checkbox = Checkbox;
exports.CheckboxButton = CheckboxButton;
exports.Chip = Chip;
exports.CircleHelpIcon = CircleHelpIcon;
exports.Clipboard = Clipboard;
exports.CodePaths = CodePaths;
exports.CodeyIcon = CodeyIcon;
exports.Collapsible = Collapsible;
exports.CollapsibleContent = CollapsibleContent;
exports.CollapsibleTrigger = CollapsibleTrigger;
exports.Combobox = ComboboxComponent;
exports.Composer = Composer;
exports.ContinueIcon = ContinueIcon;
exports.ControlCombobox = ControlComboboxMemo;
exports.CrossIcon = CrossIcon;
exports.CustomMinimalIcon = CustomMinimalIcon;
...
exports.OGDialogOverlay = DialogOverlay;
...
exports.GPTIcon = GPTIcon;
exports.GearIcon = GearIcon;
exports.GeminiIcon = GeminiIcon;
exports.GithubIcon = GithubIcon;
exports.GoogleIcon = GoogleIcon;
exports.GoogleIconChat = Google;
exports.GoogleMinimalIcon = GoogleMinimalIcon;
exports.HIGH_CONTRAST_THEME_NAME = HIGH_CONTRAST_THEME_NAME;
exports.HoverCard = HoverCard;
exports.HoverCardContent = HoverCardContent;
exports.HoverCardPortal = HoverCardPortal;
exports.HoverCardTrigger = HoverCardTrigger;
exports.IconButton = IconButton;
exports.InfoHoverCard = InfoHoverCard;
exports.Input = Input;
exports.InputCombobox = InputCombobox;
...
exports.ListeningIcon = ListeningIcon;
exports.LockIcon = LockIcon;
exports.LogOutIcon = LogOutIcon;
exports.MCPIcon = MCPIcon;
exports.MessagesSquared = MessagesSquared;
exports.MeterSwatch = MeterSwatch;
exports.MinimalPlugin = MinimalPlugin;
exports.MinutePicker = MinutePicker;
exports.MobileSidebar = MobileSidebar;
exports.MoonshotIcon = MoonshotIcon;
Object.defineProperty(exports, "MorphIcon", {
	enumerable: true,
	get: function() {
		return morphicons_react.MorphIcon;
	}
});
exports.MultiSelect = MultiSelect;
exports.NewChatIcon = NewChatIcon;
exports.NotificationSeverity = NotificationSeverity;
exports.OGDialog = Dialog$1;
exports.OGDialogClose = DialogClose$1;
exports.OGDialogContent = DialogContent$1;
exports.OGDialogDescription = DialogDescription$1;
exports.OGDialogFooter = DialogFooter$1;
exports.OGDialogHeader = DialogHeader$1;
exports.OGDialogPortal = DialogPortal;
exports.OGDialogTemplate = OGDialogTemplate;
exports.OGDialogTitle = DialogTitle$1;
exports.OGDialogTrigger = DialogTrigger$1;
exports.OpenAIMinimalIcon = OpenAIMinimalIcon;
exports.OpenIDIcon = OpenIDIcon;
exports.PaLMIcon = PaLMIcon;
exports.PaLMinimalIcon = PaLMinimalIcon;
...
exports.PersonalizationIcon = PersonalizationIcon;
exports.PinIcon = PinIcon;
exports.PixelCard = PixelCard;
exports.Plugin = Plugin;
exports.Progress = Progress;
exports.ProviderAvatar = ProviderAvatar;
exports.ProviderIcon = ProviderIcon;
exports.QuestionMark = QuestionMark;
exports.Radio = Radio;
exports.RegenerateIcon = RegenerateIcon;
exports.ResizableHandle = ResizableHandle;
exports.ResizableHandleAlt = ResizableHandleAlt;
exports.ResizablePanel = ResizablePanel;
exports.ResizablePanelGroup = ResizablePanelGroup;
exports.SERIES_SLOT_COUNT = SERIES_SLOT_COUNT;
exports.SamlIcon = SamlIcon;
exports.SaveIcon = SaveIcon;
exports.SecretInput = SecretInput;
exports.SegmentedMeter = SegmentedMeter;
...
exports.SharePointIcon = SharePointIcon;
exports.SheetPaths = SheetPaths;
exports.Sidebar = Sidebar;
exports.Skeleton = Skeleton;
exports.Slider = Slider;
exports.Sparkles = Sparkles;
exports.SpeechIcon = SpeechIcon;
exports.Spinner = Spinner;
exports.SplitText = SplitText;
exports.SquirclePlusIcon = SquirclePlusIcon;
exports.StopGeneratingIcon = StopGeneratingIcon;
exports.Switch = Switch;
exports.THEME_VERSION = THEME_VERSION;
exports.Table = Table;
...
exports.VideoPaths = VideoPaths;
exports.VirtualizedDataTable = DataTable$1;
exports.VolumeIcon = VolumeIcon;
exports.VolumeMuteIcon = VolumeMuteIcon;
exports.XAIcon = XAIcon;
exports.alertVariants = alertVariants;
exports.applyFontSize = applyFontSize;
exports.applyResolvedTheme = applyResolvedTheme;
exports.applyTheme = applyTheme;
exports.buttonVariants = buttonVariants;
exports.chatDirectionAtom = chatDirectionAtom;
exports.chipVariants = chipVariants;
exports.clearAppliedTheme = clearAppliedTheme;
exports.cn = cn;
exports.composerControlClasses = composerControlClasses;
exports.composerSubmitClasses = composerSubmitClasses;
exports.composerSurfaceClasses = composerSurfaceClasses;
exports.composerSurfaceShadow = composerSurfaceShadow;
exports.configureCloudFrontCookieRefresh = configureCloudFrontCookieRefresh;
exports.darkTheme = darkTheme;
exports.defaultAppearance = defaultAppearance;
exports.defaultBrands = defaultBrands;
exports.defaultTheme = defaultTheme;
exports.disclosureChevronVariants = disclosureChevronVariants;
exports.fieldBase = fieldBase;
exports.fieldControl = fieldControl;
exports.fontSizeAtom = fontSizeAtom;
exports.fromLegacyTheme = fromLegacyTheme;
exports.getInitialTheme = getInitialTheme;
exports.getProviderIconDef = getProviderIconDef;
exports.highContrastDarkTheme = highContrastDarkTheme;
exports.highContrastLightTheme = highContrastLightTheme;
exports.highContrastTheme = highContrastTheme;
exports.iconButtonVariants = iconButtonVariants;
exports.installCloudFrontImageRetry = installCloudFrontImageRetry;
exports.isCloudFrontMediaUrl = isCloudFrontMediaUrl;
exports.isDark = isDark;
exports.isHighContrast = isHighContrast;
exports.labelVariants = labelVariants;
exports.libreChatTheme = libreChatTheme;
exports.logger = logger;
exports.providerIcons = providerIcons;
exports.refreshCloudFrontCookiesOnce = refreshCloudFrontCookiesOnce;
exports.resolveTheme = resolveTheme;
exports.resolvesToHighContrast = resolvesToHighContrast;
exports.seriesSwatchClass = seriesSwatchClass;
exports.themeAppearanceProperties = themeAppearanceProperties;
exports.themeBrandTokens = themeBrandTokens;
exports.themeColorTokens = themeColorTokens;
exports.themeColorsAtom = themeColorsAtom;
exports.themeModeAtom = themeModeAtom;
exports.themeNameAtom = themeNameAtom;
exports.themeOwnedProperties = themeOwnedProperties;
exports.toastState = toastState;
exports.useAvatar = useAvatar;
exports.useCombobox = useCombobox;
exports.useDelayedRender = useDelayedRender;
exports.useDialogDepth = useDialogDepth;
exports.useInputModality = useInputModality;
exports.useLocalize = useLocalize;
exports.useMediaQuery = useMediaQuery;
exports.useMultiSearch = useMultiSearch;
exports.useNestedPopoverStyle = useNestedPopoverStyle;
...
exports.withCloudFrontCacheBuster = withCloudFrontCacheBuster;
