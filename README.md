...
## 📦 What's Inside
This repository contains a fully automated deployment stack for LibreChat, powered by custom Model Context Protocol (MCP) tools specifically engineered for DevOps automation:
...
Once the installer finishes and LibreChat is running on `http://localhost:3080`, check out the [SETUP_GUIDE.md](./SETUP_GUIDE.md) for the exact **Agent Instructions** you need to paste into the UI to activate the AI's DevOps capabilities.
