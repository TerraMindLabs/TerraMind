...
const HIGH_CONTRAST_LIGHT_EDITOR_THEME = 'TerraMind-high-contrast-light';
const HIGH_CONTRAST_DARK_EDITOR_THEME = 'TerraMind-high-contrast-dark';
 ...
 *  below; this one belongs to a Monaco built-in, so no TerraMind role names it
