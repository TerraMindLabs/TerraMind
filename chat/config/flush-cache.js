...
/**
 * TerraMind Cache Flush Utility
 *
 * This script flushes the cache store used by TerraMind, whether it's
...
DESCRIPTION:
  Flushes the cache store used by TerraMind. Automatically detects
...
async function restartRecommendation() {
  ...
  console.log('   consider restarting the TerraMind backend:');
  console.log('');
...
async function main() {
  ...
  console.log('🧹 TerraMind Cache Flush Utility');
  console.log('================================');
