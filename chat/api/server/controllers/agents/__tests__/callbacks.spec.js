...
jest.mock('@librechat/api', () => ({
  ...
  HOST_FILE_AUTHORING_ARTIFACT_KEY: '__TerraMind_file_authoring',
...
describe('resumable event generation fencing', () => {
  ...
  it('keeps a tool result and its input at full size in the content parts TerraMind persists', async () => {
    ...
    function makeCodeExecutionEvent({
      ...
      return {
        output: {
          ...
          artifact: {
            ...(hostFileAuthoring ? { __TerraMind_file_authoring: true } : {}),
