...
};`;function g(e){let t=e?o:n,r=(e,n)=>{let r=t[e]?.trim().split(/\s+/).map(Number);return r?.length!==3||r.some(Number.isNaN)?n:`#${r.map(e=>e.toString(16).padStart(2,`0`)).join(``)}`},i=r(`rgb-surface-primary`,e?`#000000`:`#ffffff`),a=r(`rgb-text-primary`,e?`#ffffff`:`#000000`),s=r(`rgb-link`,e?`#8cc8ff`:`#0000cc`),c=r(`rgb-border-medium`,a);return`
