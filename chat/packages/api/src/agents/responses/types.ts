...
export interface TerraMindAttachmentContent {
 ...
 */
export interface TerraMindAttachmentEvent extends BaseEvent {
...
export type ResponseEvent =
  ...
  | ReasoningDoneEvent
  | ErrorEvent
  // TerraMind extensions (prefixed per Open Responses spec)
  | TerraMindAttachmentEvent;
