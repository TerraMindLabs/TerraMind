...
describe('webSearchSchema', () => {
  ...
  it('accepts Keenable search options', () => {
    ...
    expect(result.keenableSearchOptions?.attributionTitle).toBe('TerraMind');
  ...
  it('accepts Keenable as a scraper provider with its options', () => {
    ...
    expect(result.keenableScraperOptions?.attributionTitle).toBe('TerraMind');
