# TerraMind Localization Guide

This guide explains how to add new languages to TerraMind's localization system.

## Adding a New Language

To add a new language to TerraMind, follow these steps:

### 1. Add the Language to Locize Project

- Navigate to the [TerraMind locize project](https://www.locize.app/cat/62uyy7c9),
...
1. The empty translation file will be populated through TerraMind's automated translation platform
