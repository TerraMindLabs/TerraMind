...
describe('theme registry', () => {
  ...
  it('resolves partial definitions against mode-specific TerraMind defaults', () => {
   ...
   *  not "wants TerraMind's sweep". Filling it from the bundled base would light
   ...
   *  contrast was only ever measured against TerraMind's surfaces. */
  ...
  it('derives it from the inherited text of an owned scale that names no text', () => {
     ...
     *  and its surfaces but reads body copy in TerraMind's own colours, so the
