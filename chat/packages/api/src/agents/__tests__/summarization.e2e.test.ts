 ...
 *
 * Exercises the FULL TerraMind -> agents pipeline:
 *   TerraMind's createRun (@librechat/api)
...
(hasAnthropic ? describe : describe.skip)('Anthropic Summarization E2E (TerraMind)', () => {
...
(hasOpenAI ? describe : describe.skip)('OpenAI Summarization E2E (TerraMind)', () => {
  jest.setTimeout(180_000);
...
(hasBothProviders ? describe : describe.skip)(
  'Cross-provider Summarization E2E (TerraMind)',
  () => {
    jest.setTimeout(180_000);
