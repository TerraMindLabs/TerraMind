...
describe('Code API JWT minting', () => {
  ...
  it('mints a Code API-scoped token from canonical TerraMind JWT context', async () => {
  ...
  it('marks OpenID users authenticated by TerraMind JWT as TerraMind JWT callers', async () => {
    process.env.OPENID_REUSE_TOKENS = 'true';
